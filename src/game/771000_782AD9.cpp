...
void sub_770FED(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(ts->ebp));
	mov(&ts->ebp, x86::reg32(ts->esp));
	cmp(mv, &ts->eflags, x86::mem(ts->ebp + 0x8, 4), x86::reg32(0x0));
	push(mv, &ts->esp, x86::reg32(ts->esi));
	mov(&ts->esi, x86::reg32(0x8B88B0));
	if (ts->eflags.zero) {
        goto loc_771013;
    }
	lea(mv, &ts->eax, x86::mem(ts->ebp + 0xC, 4));
	push(mv, &ts->esp, x86::reg32(ts->eax));
	push(mv, &ts->esp, x86::mem(ts->ebp + 0x8, 4));
	push(mv, &ts->esp, x86::reg32(0x800));
	push(mv, &ts->esp, x86::reg32(ts->esi));
	game::__vsnprintf(ts, mv);
	add(&ts->esp, x86::reg32(0x10));
	goto loc_77101A;

loc_771013:
	mov(mv, x86::mem(0x8B88B0, 1), x86::reg8(0x0));

loc_77101A:
	push(mv, &ts->esp, x86::reg32(ts->esi));
	push(mv, &ts->esp, x86::reg32(0x786E70));
	call(ts, mv, x86::mem(0x81CAFC, 4));
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	pop(mv, &ts->esp, x86::reg32(ts->esi));
	pop(mv, &ts->esp, x86::reg32(ts->ebp));
	retn(mv, &ts->esp);
}
...
loc_771051:
	mov(mv, x86::mem(0x8B90B0, 1), x86::reg8(0x0));

loc_771058:
	push(mv, &ts->esp, x86::reg32(ts->esi));
	push(mv, &ts->esp, x86::reg32(0x7DD638));
	push(mv, &ts->esp, x86::reg32(0x2));
	game::sub_771082(ts, mv);
	add(&ts->esp, x86::reg32(0xC));
	pop(mv, &ts->esp, x86::reg32(ts->esi));
	pop(mv, &ts->esp, x86::reg32(ts->ebp));
	goto sub_770FDB;
}
...
void sub_77106F(x86::thread_state* ts, x86::memory_view* mv) {
	...
	mov(mv, x86::mem(0x81CAFC, 4), x86::reg32(ts->ecx));
	pop(mv, &ts->esp, x86::reg32(ts->ebp));
	retn(mv, &ts->esp);
}
...
void _longjmp(x86::thread_state* ts, x86::memory_view* mv) {
	...
	cmp(mv, &ts->eflags, x86::reg32(ts->esi), x86::mem(0x0, 4));
	if (ts->eflags.zero) {
        goto _lj_local_unwind;
    }
	push(mv, &ts->esp, x86::reg32(ts->esi));
	game::__global_unwind2(ts, mv);
	add(&ts->esp, x86::reg32(0x4));

_lj_local_unwind:
	cmp(&ts->eflags, x86::reg32(ts->esi), x86::reg32(0x0));
	if (ts->eflags.zero) {
        goto _lj_no_unwind;
    }
	...
	or_(&ts->eax, x86::reg32(ts->eax));
	if (ts->eflags.zero) {
        goto _lj_old_unwind;
    }
	mov(mv, &ts->eax, x86::mem(ts->ebx + 0x20, 4));
	cmp(&ts->eflags, x86::reg32(ts->eax), x86::reg32(0x56433230));
	if (!ts->eflags.zero) {
        goto _lj_old_unwind;
    }
	...
	push(mv, &ts->esp, x86::reg32(ts->ebx));
	call(ts, mv, x86::reg32(ts->eax));
	goto _lj_no_unwind;
...
_lj_old_unwind:
	...
	add(&ts->esp, x86::reg32(0x8));

_lj_no_unwind:
	push(mv, &ts->esp, x86::reg32(0x0));
	mov(mv, &ts->eax, x86::mem(ts->ebx + 0x14, 4));
	game::__NLG_Notify(ts, mv);
	mov(&ts->edx, x86::reg32(ts->ebx));
	...
	cmp(&ts->eflags, x86::reg32(ts->eax), x86::reg32(0x1));
	adc(&ts->eax, x86::reg32(0x0));
	mov(mv, &ts->esp, x86::mem(ts->edx + 0x10, 4));
	add(&ts->esp, x86::reg32(0x4));
	jmp(ts, mv, x86::mem(ts->edx + 0x14, 4));
}
...
void __setjmp3(x86::thread_state* ts, x86::memory_view* mv) {
	...
	mov(mv, x86::mem(ts->edx, 4), x86::reg32(ts->ebp));
	mov(mv, x86::mem(ts->edx + 0x4, 4), x86::reg32(ts->ebx));
	mov(mv, x86::mem(ts->edx + 0x8, 4), x86::reg32(ts->edi));
	mov(mv, x86::mem(ts->edx + 0xC, 4), x86::reg32(ts->esi));
	mov(mv, x86::mem(ts->edx + 0x10, 4), x86::reg32(ts->esp));
	mov(mv, &ts->eax, x86::mem(ts->esp, 4));
	mov(mv, x86::mem(ts->edx + 0x14, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(ts->edx + 0x20, 4), x86::reg32(0x56433230));
	mov(mv, x86::mem(ts->edx + 0x24, 4), x86::reg32(0x0));
	mov(mv, &ts->eax, x86::mem(0x0, 4));
	mov(mv, x86::mem(ts->edx + 0x18, 4), x86::reg32(ts->eax));
	cmp(&ts->eflags, x86::reg32(ts->eax), x86::reg32(0xFFFFFFFF));
	if (!ts->eflags.zero) {
        goto _s3_get_count;
    }
	mov(mv, x86::mem(ts->edx + 0x1C, 4), x86::reg32(0xFFFFFFFF));
	goto _s3_done;

_s3_get_count:
	mov(mv, &ts->ecx, x86::mem(ts->esp + 0x8, 4));
	or_(&ts->ecx, x86::reg32(ts->ecx));
	if (ts->eflags.zero) {
        goto _s3_default_trylevel;
    }
	mov(mv, &ts->eax, x86::mem(ts->esp + 0xC, 4));
	mov(mv, x86::mem(ts->edx + 0x24, 4), x86::reg32(ts->eax));
	dec(&ts->ecx);
	if (!ts->eflags.zero) {
...
_s3_default_trylevel:
	...
	mov(mv, x86::mem(ts->edx + 0x1C, 4), x86::reg32(ts->eax));
	goto _s3_done;
...
_s3_save_trylevel:
	...
	push(mv, &ts->esp, x86::reg32(ts->esi));
	push(mv, &ts->esp, x86::reg32(ts->edi));
	lea(mv, &ts->esi, x86::mem(ts->esp + 0x1C, 4));
	lea(mv, &ts->edi, x86::mem(ts->edx + 0x28, 4));
	cmp(&ts->eflags, x86::reg32(ts->ecx), x86::reg32(0x6));
	if (ts->eflags.carry || ts->eflags.zero) {
        goto _s3_save_data;
    }
	mov(&ts->ecx, x86::reg32(0x6));

_s3_save_data:
	movs(mv, x86::mem(ts->edi, 4), x86::mem(ts->esi, 4));
	pop(mv, &ts->esp, x86::reg32(ts->edi));
	pop(mv, &ts->esp, x86::reg32(ts->esi));

_s3_done:
	sub(&ts->eax, x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void __aullshr(x86::thread_state* ts, x86::memory_view* mv) {
	cmp(&ts->eflags, x86::reg8(ts->cl), x86::reg8(0x40));
	if (!ts->eflags.carry) {
        goto RETZERO_0;
    }
	cmp(&ts->eflags, x86::reg8(ts->cl), x86::reg8(0x20));
	if (!ts->eflags.carry) {
        goto MORE32_1;
    }
	shrd(&ts->eax, x86::reg32(ts->edx), x86::reg8(ts->cl));
	shr(&ts->edx, x86::reg8(ts->cl));
	retn(mv, &ts->esp);

MORE32_1:
	mov(&ts->eax, x86::reg32(ts->edx));
	xor_(&ts->edx, x86::reg32(ts->edx));
	and_(&ts->cl, x86::reg8(0x1F));
	shr(&ts->eax, x86::reg8(ts->cl));
	retn(mv, &ts->esp);

RETZERO_0:
	xor_(&ts->eax, x86::reg32(ts->eax));
	xor_(&ts->edx, x86::reg32(ts->edx));
	retn(mv, &ts->esp);
}

void _rt_probe_read4_x_(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0xC));
	push(mv, &ts->esp, x86::reg32(0x7DD648));
	game::__SEH_prolog(ts, mv);
	and_(mv, x86::mem(ts->ebp - 0x4, 4), x86::reg32(0x0));
	mov(mv, &ts->eax, x86::mem(ts->ebp + 0x8, 4));
	mov(mv, &ts->eax, x86::mem(ts->eax, 4));
	xor_(&ts->eax, x86::reg32(ts->eax));
	inc(&ts->eax);
	mov(mv, x86::mem(ts->ebp - 0x1C, 4), x86::reg32(ts->eax));
	goto loc_771235;
...
loc_77121C:
	...
	mov(mv, &ts->eax, x86::mem(ts->eax, 4));
	mov(mv, &ts->eax, x86::mem(ts->eax, 4));
	xor_(&ts->ecx, x86::reg32(ts->ecx));
	cmp(&ts->eflags, x86::reg32(ts->eax), x86::reg32(0xC0000005));
	setz(ts->eflags, &ts->cl);
	mov(&ts->eax, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
...
loc_771235:
	or_(mv, x86::mem(ts->ebp - 0x4, 4), x86::reg32(0xFFFFFFFF));
	game::__SEH_epilog(ts, mv);
	retn(mv, &ts->esp, x86::reg16(0x4));
}

void __rmtmp(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x10));
	push(mv, &ts->esp, x86::reg32(0x7DD658));
	game::__SEH_prolog(ts, mv);
	xor_(&ts->esi, x86::reg32(ts->esi));
	mov(mv, x86::mem(ts->ebp - 0x1C, 4), x86::reg32(ts->esi));
	push(mv, &ts->esp, x86::reg32(0x1));
	game::__lock(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	mov(mv, x86::mem(ts->ebp - 0x4, 4), x86::reg32(ts->esi));

loc_77125D:
	mov(mv, x86::mem(ts->ebp - 0x20, 4), x86::reg32(ts->esi));
	cmp(mv, &ts->eflags, x86::reg32(ts->esi), x86::mem(0x8BB5E0, 4));
	if (ts->eflags.sign == ts->eflags.overflow) {
        goto loc_7712C8;
    }
	mov(mv, &ts->eax, x86::mem(0x8BA5C0, 4));
	mov(mv, &ts->eax, x86::mem(ts->eax + (ts->esi*4), 4));
	test(&ts->eflags, x86::reg32(ts->eax), x86::reg32(ts->eax));
	if (ts->eflags.zero) {
        goto loc_7712B1;
    }
	test(mv, &ts->eflags, x86::mem(ts->eax + 0xC, 1), x86::reg8(0x83));
	if (ts->eflags.zero) {
        goto loc_7712B1;
    }
	push(mv, &ts->esp, x86::reg32(ts->eax));
	...
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	mov(mv, x86::mem(ts->ebp - 0x4, 4), x86::reg32(0x1));
	mov(mv, &ts->eax, x86::mem(0x8BA5C0, 4));
	mov(mv, &ts->eax, x86::mem(ts->eax + (ts->esi*4), 4));
	test(mv, &ts->eflags, x86::mem(ts->eax + 0xC, 1), x86::reg8(0x83));
	if (ts->eflags.zero) {
	...
	cmp(mv, &ts->eflags, x86::mem(ts->eax + 0x1C, 4), x86::reg32(0x0));
	if (ts->eflags.zero) {
        goto loc_7712A8;
    }
	push(mv, &ts->esp, x86::reg32(ts->eax));
...
void sub_776572(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7980F0));
...
void sub_77A640(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x5));
	push(mv, &ts->esp, x86::reg32(0x7E9BC8));
	mov(&ts->ecx, x86::reg32(0x81E378));
...
void sub_77A660(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x2));
	push(mv, &ts->esp, x86::reg32(0x7E9BF0));
	mov(&ts->ecx, x86::reg32(0x81E7DC));
	game::sub_576770(ts, mv);
	retn(mv, &ts->esp);
}
...
void sub_77A680(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x2));
	push(mv, &ts->esp, x86::reg32(0x7E9C00));
	mov(&ts->ecx, x86::reg32(0x827A10));
	game::sub_576770(ts, mv);
	retn(mv, &ts->esp);
}

void sub_77A6A0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x81E5B8));
	game::sub_414CF0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781980));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77A6C0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x81E388));
	game::sub_414CF0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781990));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77A6E0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x781940));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77A710(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0xB));
	push(mv, &ts->esp, x86::reg32(0x7E9C10));
	mov(&ts->ecx, x86::reg32(0x81E380));
	game::sub_576770(ts, mv);
	retn(mv, &ts->esp);
}
...
void sub_77A730(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x2));
	push(mv, &ts->esp, x86::reg32(0x7E9C68));
	mov(&ts->ecx, x86::reg32(0x81E370));
	game::sub_576770(ts, mv);
	retn(mv, &ts->esp);
}

void sub_77A750(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0xA));
	push(mv, &ts->esp, x86::reg32(0x7E9C78));
	mov(&ts->ecx, x86::reg32(0x827A18));
	game::sub_576770(ts, mv);
	retn(mv, &ts->esp);
}

void sub_77A770(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x9));
	push(mv, &ts->esp, x86::reg32(0x7E9CC8));
	mov(&ts->ecx, x86::reg32(0x81E7F4));
	game::sub_576770(ts, mv);
	retn(mv, &ts->esp);
}
...
void sub_77A790(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x2));
	push(mv, &ts->esp, x86::reg32(0x7E9D24));
	mov(&ts->ecx, x86::reg32(0x81E800));
	game::sub_576770(ts, mv);
	retn(mv, &ts->esp);
}
...
void sub_77A7B0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x2));
	push(mv, &ts->esp, x86::reg32(0x7E9D34));
	mov(&ts->ecx, x86::reg32(0x81E7E4));
	game::sub_576770(ts, mv);
	retn(mv, &ts->esp);
}

void sub_77A7D0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(mv, x86::mem(0x81E5AC, 4), x86::reg32(0x3DD67750));
	retn(mv, &ts->esp);
}

void sub_77A7E0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x4));
	push(mv, &ts->esp, x86::reg32(0x7E9F58));
	mov(&ts->ecx, x86::reg32(0x81E5B0));
	game::sub_576770(ts, mv);
	retn(mv, &ts->esp);
}

void sub_77A800(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x81E7EC));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781960));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77A820(x86::thread_state* ts, x86::memory_view* mv) {
	...
	mov(&ts->ecx, x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7EA088, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7EA08C, 4), x86::reg32(ts->ecx));
	mov(mv, &ts->ecx, x86::mem(0x783C2C, 4));
	mov(&ts->eax, x86::reg32(ts->edx));
	mov(mv, x86::mem(0x7EA0C0, 4), x86::reg32(ts->edx));
	mov(&ts->edx, x86::reg32(ts->ecx));
	mov(mv, x86::mem(0x7EA0C4, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7EA0C8, 4), x86::reg32(ts->ecx));
	mov(&ts->cl, x86::reg8(0x80));
	mov(&ts->al, x86::reg8(0x25));
	mov(mv, x86::mem(0x7EA0E8, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7EA0E9, 1), x86::reg8(ts->al));
	xor_(&ts->eax, x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7EA0EE, 1), x86::reg8(ts->cl));
	mov(mv, x86::mem(0x7EA0EF, 1), x86::reg8(ts->cl));
	mov(mv, x86::mem(0x7EA0F0, 1), x86::reg8(ts->cl));
	mov(mv, x86::mem(0x7EA0F1, 1), x86::reg8(ts->cl));
	mov(mv, x86::mem(0x7EA0F2, 1), x86::reg8(ts->cl));
	mov(mv, x86::mem(0x7EA0F3, 1), x86::reg8(ts->cl));
	mov(&ts->cl, x86::reg8(0x32));
	mov(mv, x86::mem(0x7EA090, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7EA094, 4), x86::reg32(0x41200000));
	mov(mv, x86::mem(0x7EA098, 4), x86::reg32(0x40000000));
	mov(mv, x86::mem(0x7EA09C, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7EA0A0, 4), x86::reg32(0x41200000));
	mov(mv, x86::mem(0x7EA0A4, 4), x86::reg32(0x40000000));
	mov(mv, x86::mem(0x7EA0A8, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7EA0AC, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7EA0B0, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7EA0B4, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7EA0B8, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7EA0BC, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7EA0CC, 4), x86::reg32(ts->edx));
	mov(mv, x86::mem(0x7EA0D0, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7EA0D4, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7EA0D8, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7EA0DC, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7EA0E0, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7EA0E4, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7EA0EA, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7EA0EB, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7EA0EC, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7EA0ED, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7EA0F4, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7EA0F5, 1), x86::reg8(ts->cl));
	mov(mv, x86::mem(0x7EA0F6, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7EA0F7, 1), x86::reg8(ts->cl));
	mov(mv, x86::mem(0x7EA0F8, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7EA0F9, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7EA0FC, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77A980(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x781950));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77A990(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x81E810));
	game::sub_41AA60(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7819A0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77A9B0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x81CBC0));
	game::sub_4130A0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781970));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77AA50(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x781A30));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77AA60(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7864E8));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x4));
	mov(mv, x86::mem(0x827D34, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77AA80(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7864FC));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x4));
	mov(mv, x86::mem(0x827C5C, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77AAA0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x786510));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x4));
	mov(mv, x86::mem(0x827C68, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77AAC0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x786520));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x4));
	mov(mv, x86::mem(0x827C98, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77AAE0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x786530));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x4));
	mov(mv, x86::mem(0x827DAC, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77AB00(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x786548));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x4));
	mov(mv, x86::mem(0x827C7C, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77AB20(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x786560));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x4));
	mov(mv, x86::mem(0x827F40, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77AB40(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x78657C));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x4));
	mov(mv, x86::mem(0x827C8C, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77AB60(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x786598));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x4));
	mov(mv, x86::mem(0x827DB0, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77AB80(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x827E88));
	game::sub_4301D0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781A40));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77ABA0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x827C3C));
	game::sub_57BCD0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781B10));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77ABC0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x827D98));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781B30));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77ABE0(x86::thread_state* ts, x86::memory_view* mv) {
	...
	mov(mv, x86::mem(0x827C38, 1), x86::reg8(ts->al));
	retn(mv, &ts->esp);
}

void sub_77ABF0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x827B88));
	game::sub_435B80(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781B60));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77AC10(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x827C60));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781B20));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77AC30(x86::thread_state* ts, x86::memory_view* mv) {
	...
	mov(&ts->ecx, x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7EA4F0, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7EA4F4, 4), x86::reg32(ts->ecx));
	mov(mv, &ts->ecx, x86::mem(0x785BEC, 4));
	mov(&ts->eax, x86::reg32(ts->edx));
	mov(mv, x86::mem(0x7EA528, 4), x86::reg32(ts->edx));
	mov(&ts->edx, x86::reg32(ts->ecx));
	mov(mv, x86::mem(0x7EA52C, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7EA530, 4), x86::reg32(ts->ecx));
	mov(&ts->cl, x86::reg8(0x80));
	mov(&ts->al, x86::reg8(0x25));
	mov(mv, x86::mem(0x7EA550, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7EA551, 1), x86::reg8(ts->al));
	xor_(&ts->eax, x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7EA556, 1), x86::reg8(ts->cl));
	mov(mv, x86::mem(0x7EA557, 1), x86::reg8(ts->cl));
	mov(mv, x86::mem(0x7EA558, 1), x86::reg8(ts->cl));
	mov(mv, x86::mem(0x7EA559, 1), x86::reg8(ts->cl));
	mov(mv, x86::mem(0x7EA55A, 1), x86::reg8(ts->cl));
	mov(mv, x86::mem(0x7EA55B, 1), x86::reg8(ts->cl));
	mov(&ts->cl, x86::reg8(0x32));
	mov(mv, x86::mem(0x7EA4F8, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7EA4FC, 4), x86::reg32(0x41200000));
	mov(mv, x86::mem(0x7EA500, 4), x86::reg32(0x40000000));
	mov(mv, x86::mem(0x7EA504, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7EA508, 4), x86::reg32(0x41200000));
	mov(mv, x86::mem(0x7EA50C, 4), x86::reg32(0x40000000));
	mov(mv, x86::mem(0x7EA510, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7EA514, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7EA518, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7EA51C, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7EA520, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7EA524, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7EA534, 4), x86::reg32(ts->edx));
	mov(mv, x86::mem(0x7EA538, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7EA53C, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7EA540, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7EA544, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7EA548, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7EA54C, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7EA552, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7EA553, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7EA554, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7EA555, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7EA55C, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7EA55D, 1), x86::reg8(ts->cl));
	mov(mv, x86::mem(0x7EA55E, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7EA55F, 1), x86::reg8(ts->cl));
	mov(mv, x86::mem(0x7EA560, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7EA561, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7EA564, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77AD90(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x786458));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x4));
	mov(mv, x86::mem(0x827F60, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77ADB0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x827B80));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781AD0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77ADD0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->eax, x86::reg32(0x827BA0));
	mov(&ts->edx, x86::reg32(0x8));
	xor_(&ts->ecx, x86::reg32(ts->ecx));
	lea(mv, &ts->esp, x86::mem(ts->esp, 4));

loc_77ADE0:
	mov(mv, x86::mem(ts->eax - 0x8, 4), x86::reg32(ts->ecx));
	mov(mv, x86::mem(ts->eax - 0x4, 4), x86::reg32(ts->ecx));
	mov(mv, x86::mem(ts->eax, 4), x86::reg32(ts->ecx));
	mov(mv, x86::mem(ts->eax + 0x4, 4), x86::reg32(ts->ecx));
	mov(mv, x86::mem(ts->eax + 0x8, 4), x86::reg32(0xFFFFFFFF));
	add(&ts->eax, x86::reg32(0x14));
	dec(&ts->edx);
	if (!ts->eflags.zero) {
        goto loc_77ADE0;
    }
...
void sub_77AE00(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x78660C));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x786600));
	mov(mv, x86::mem(0x827FA4, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7865F4));
	mov(mv, x86::mem(0x827FA8, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7865E8));
	mov(mv, x86::mem(0x827FAC, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7865DC));
	mov(mv, x86::mem(0x827FB0, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7865D0));
	mov(mv, x86::mem(0x827FB4, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7865C4));
	mov(mv, x86::mem(0x827FB8, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7865B8));
	mov(mv, x86::mem(0x827FBC, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x20));
	mov(mv, x86::mem(0x827FC0, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77AE80(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x78666C));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x786660));
	mov(mv, x86::mem(0x827F64, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x786654));
	mov(mv, x86::mem(0x827F68, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x786648));
	mov(mv, x86::mem(0x827F6C, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x78663C));
	mov(mv, x86::mem(0x827F70, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x786630));
	mov(mv, x86::mem(0x827F74, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x786624));
	mov(mv, x86::mem(0x827F78, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x786618));
	mov(mv, x86::mem(0x827F7C, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x20));
	mov(mv, x86::mem(0x827F80, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77AF00(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7866CC));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7866C0));
	mov(mv, x86::mem(0x827FC4, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7866B4));
	mov(mv, x86::mem(0x827FC8, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7866A8));
	mov(mv, x86::mem(0x827FCC, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x78669C));
	mov(mv, x86::mem(0x827FD0, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x786690));
	mov(mv, x86::mem(0x827FD4, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x786684));
	mov(mv, x86::mem(0x827FD8, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x786678));
	mov(mv, x86::mem(0x827FDC, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x20));
	mov(mv, x86::mem(0x827FE0, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77AF80(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x78672C));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x786720));
	mov(mv, x86::mem(0x827F84, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x786714));
	mov(mv, x86::mem(0x827F88, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x786708));
	mov(mv, x86::mem(0x827F8C, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7866FC));
	mov(mv, x86::mem(0x827F90, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7866F0));
	mov(mv, x86::mem(0x827F94, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7866E4));
	mov(mv, x86::mem(0x827F98, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7866D8));
	mov(mv, x86::mem(0x827F9C, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x20));
	mov(mv, x86::mem(0x827FA0, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77B000(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x4022C0));
	push(mv, &ts->esp, x86::reg32(0x4FE910));
	push(mv, &ts->esp, x86::reg32(0x8));
	push(mv, &ts->esp, x86::reg32(0xC));
	push(mv, &ts->esp, x86::reg32(0x827D38));
	game::sub_75C461(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7819B0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77B030(x86::thread_state* ts, x86::memory_view* mv) {
	...
	push(mv, &ts->esp, x86::reg32(0x8));
	push(mv, &ts->esp, x86::reg32(0xC));
	push(mv, &ts->esp, x86::reg32(0x827DB8));
	game::sub_75C461(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7819D0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77B060(x86::thread_state* ts, x86::memory_view* mv) {
	...
	push(mv, &ts->esp, x86::reg32(0x8));
	push(mv, &ts->esp, x86::reg32(0xC));
	push(mv, &ts->esp, x86::reg32(0x827E28));
	game::sub_75C461(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7819F0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77B090(x86::thread_state* ts, x86::memory_view* mv) {
	...
	push(mv, &ts->esp, x86::reg32(0x8));
	push(mv, &ts->esp, x86::reg32(0xC));
	push(mv, &ts->esp, x86::reg32(0x827CD0));
	game::sub_75C461(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781A10));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77B0C0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x781A50));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77B0D0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x781A70));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77B0E0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x781A90));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77B0F0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x781AB0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77B100(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x827C9C));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781AE0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77B120(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x827CA4));
	game::sub_57BCD0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781B40));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77B140(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x785C3C));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x4));
	mov(mv, x86::mem(0x827C84, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77B160(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x786738));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x4));
	mov(mv, x86::mem(0x827F54, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77B180(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x786748));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x4));
	mov(mv, x86::mem(0x827C6C, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77B1A0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x786760));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x4));
	mov(mv, x86::mem(0x827F48, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77B1C0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x786774));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x4));
	mov(mv, x86::mem(0x827F4C, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77B1E0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x78678C));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x4));
	mov(mv, x86::mem(0x827CC8, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77B200(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7867A0));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x4));
	mov(mv, x86::mem(0x827F44, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77B220(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7867B4));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x4));
	mov(mv, x86::mem(0x827F5C, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77B240(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7867CC));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x4));
	mov(mv, x86::mem(0x827F58, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77B260(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7867E4));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x4));
	mov(mv, x86::mem(0x827F50, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77B280(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7867F8));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x4));
	mov(mv, x86::mem(0x827C44, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77B2A0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x786810));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x4));
	mov(mv, x86::mem(0x827C58, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77B2C0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x786828));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x4));
	mov(mv, x86::mem(0x827C94, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77B2E0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x786838));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x4));
	mov(mv, x86::mem(0x827C90, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77B300(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x78684C));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x4));
	mov(mv, x86::mem(0x827C70, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77B320(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x786860));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x4));
	mov(mv, x86::mem(0x827C54, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77B340(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x786874));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x4));
	mov(mv, x86::mem(0x827C80, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77B360(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x786888));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x4));
	mov(mv, x86::mem(0x827DB4, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77B380(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7868A0));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x4));
	mov(mv, x86::mem(0x827D30, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77B3A0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7868B8));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x4));
	mov(mv, x86::mem(0x827C88, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77B3C0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7868D0));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x4));
	mov(mv, x86::mem(0x827E18, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}
...
void sub_77B3E0(x86::thread_state* ts, x86::memory_view* mv) {
	...
	mov(mv, x86::mem(0x7EA56C, 4), x86::reg32(ts->eax));
	mov(mv, &ts->eax, x86::mem(0x827F48, 4));
	mov(mv, x86::mem(0x7EA574, 4), x86::reg32(ts->ecx));
	mov(mv, &ts->ecx, x86::mem(0x827F4C, 4));
	mov(mv, x86::mem(0x7EA57C, 4), x86::reg32(ts->edx));
	mov(mv, &ts->edx, x86::mem(0x827CC8, 4));
	mov(mv, x86::mem(0x7EA584, 4), x86::reg32(ts->eax));
	mov(mv, &ts->eax, x86::mem(0x827F44, 4));
	mov(mv, x86::mem(0x7EA58C, 4), x86::reg32(ts->ecx));
	mov(mv, &ts->ecx, x86::mem(0x827F5C, 4));
	mov(mv, x86::mem(0x7EA594, 4), x86::reg32(ts->edx));
	mov(mv, &ts->edx, x86::mem(0x827F58, 4));
	mov(mv, x86::mem(0x7EA59C, 4), x86::reg32(ts->eax));
	mov(mv, &ts->eax, x86::mem(0x827F50, 4));
	mov(mv, x86::mem(0x7EA5A4, 4), x86::reg32(ts->ecx));
	mov(mv, &ts->ecx, x86::mem(0x827C44, 4));
	mov(mv, x86::mem(0x7EA5AC, 4), x86::reg32(ts->edx));
	mov(mv, &ts->edx, x86::mem(0x827C58, 4));
	mov(mv, x86::mem(0x7EA5B4, 4), x86::reg32(ts->eax));
	mov(mv, &ts->eax, x86::mem(0x827C94, 4));
	mov(mv, x86::mem(0x7EA5BC, 4), x86::reg32(ts->ecx));
	mov(mv, &ts->ecx, x86::mem(0x827C90, 4));
	mov(mv, x86::mem(0x7EA5C4, 4), x86::reg32(ts->edx));
	mov(mv, &ts->edx, x86::mem(0x827C70, 4));
	mov(mv, x86::mem(0x7EA5CC, 4), x86::reg32(ts->eax));
	mov(mv, &ts->eax, x86::mem(0x827C54, 4));
	mov(mv, x86::mem(0x7EA5D4, 4), x86::reg32(ts->ecx));
	mov(mv, &ts->ecx, x86::mem(0x827C80, 4));
	mov(mv, x86::mem(0x7EA5DC, 4), x86::reg32(ts->edx));
	mov(mv, &ts->edx, x86::mem(0x827DB4, 4));
	mov(mv, x86::mem(0x7EA5E4, 4), x86::reg32(ts->eax));
	mov(mv, &ts->eax, x86::mem(0x827D30, 4));
	mov(mv, x86::mem(0x7EA5EC, 4), x86::reg32(ts->ecx));
	mov(mv, &ts->ecx, x86::mem(0x827C88, 4));
	mov(mv, x86::mem(0x7EA5F4, 4), x86::reg32(ts->edx));
	mov(mv, &ts->edx, x86::mem(0x827E18, 4));
	mov(mv, x86::mem(0x7EA570, 4), x86::reg32(0x786738));
	mov(mv, x86::mem(0x7EA578, 4), x86::reg32(0x786748));
	mov(mv, x86::mem(0x7EA580, 4), x86::reg32(0x786760));
	mov(mv, x86::mem(0x7EA588, 4), x86::reg32(0x786774));
	mov(mv, x86::mem(0x7EA590, 4), x86::reg32(0x78678C));
	mov(mv, x86::mem(0x7EA598, 4), x86::reg32(0x7867A0));
	mov(mv, x86::mem(0x7EA5A0, 4), x86::reg32(0x7867B4));
	mov(mv, x86::mem(0x7EA5A8, 4), x86::reg32(0x7867CC));
	mov(mv, x86::mem(0x7EA5B0, 4), x86::reg32(0x7867E4));
	mov(mv, x86::mem(0x7EA5B8, 4), x86::reg32(0x7867F8));
	mov(mv, x86::mem(0x7EA5C0, 4), x86::reg32(0x786810));
	mov(mv, x86::mem(0x7EA5C8, 4), x86::reg32(0x786828));
	mov(mv, x86::mem(0x7EA5D0, 4), x86::reg32(0x786838));
	mov(mv, x86::mem(0x7EA5D8, 4), x86::reg32(0x78684C));
	mov(mv, x86::mem(0x7EA5E0, 4), x86::reg32(0x786860));
	mov(mv, x86::mem(0x7EA5E8, 4), x86::reg32(0x786874));
	mov(mv, x86::mem(0x7EA5F0, 4), x86::reg32(0x786888));
	mov(mv, x86::mem(0x7EA5F8, 4), x86::reg32(0x7868A0));
	mov(mv, x86::mem(0x7EA5FC, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7EA600, 4), x86::reg32(0x7868B8));
	mov(mv, x86::mem(0x7EA604, 4), x86::reg32(ts->ecx));
	mov(mv, x86::mem(0x7EA608, 4), x86::reg32(0x7868D0));
	mov(mv, x86::mem(0x7EA60C, 4), x86::reg32(ts->edx));
	retn(mv, &ts->esp);
}

void sub_77B5A0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x827DA4));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781AF0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77B5C0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x827C74));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781B00));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77B5E0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x827EF0));
	game::sub_439EA0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781B50));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77B600(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x828520));
	game::sub_57BCD0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781B80));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77B620(x86::thread_state* ts, x86::memory_view* mv) {
	...
	mov(mv, x86::mem(0x7EB3F4, 4), x86::reg32(ts->eax));
	mov(mv, &ts->al, x86::mem(0x827FE8, 1));
	inc(&ts->al);
	mov(mv, x86::mem(0x828050, 4), x86::reg32(0x7EB3F4));
	mov(mv, x86::mem(0x827FE8, 1), x86::reg8(ts->al));
	retn(mv, &ts->esp);
}

void sub_77B650(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x828528));
	game::sub_43E820(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781B70));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77B670(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x828530));
	game::sub_4407B0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781B90));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77B6B0(x86::thread_state* ts, x86::memory_view* mv) {
	...
	mov(&ts->ecx, x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7EC7C4, 4), x86::reg32(ts->ecx));
	mov(mv, &ts->ecx, x86::mem(0x786F88, 4));
	mov(mv, x86::mem(0x7EC7C0, 4), x86::reg32(ts->eax));
	mov(&ts->eax, x86::reg32(ts->edx));
	mov(mv, x86::mem(0x7EC7F8, 4), x86::reg32(ts->edx));
	mov(&ts->edx, x86::reg32(ts->ecx));
	mov(mv, x86::mem(0x7EC7FC, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7EC800, 4), x86::reg32(ts->ecx));
	mov(mv, x86::mem(0x7EC804, 4), x86::reg32(ts->edx));
	retn(mv, &ts->esp);
}

void sub_77B6F0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7881E4));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7881E0));
	mov(mv, x86::mem(0x7EC1F8, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7881D4));
	mov(mv, x86::mem(0x7EC1FC, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7EC214, 4), x86::reg32(0x7881CC));
	mov(mv, x86::mem(0x7EC218, 4), x86::reg32(0x441B40));
	mov(mv, x86::mem(0x7EC21C, 4), x86::reg32(0x404800));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7881CC));
	mov(mv, x86::mem(0x7EC20C, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7881BC));
	mov(mv, x86::mem(0x7EC210, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7EC228, 4), x86::reg32(0x7881B4));
	mov(mv, x86::mem(0x7EC22C, 4), x86::reg32(0x441BF0));
	mov(mv, x86::mem(0x7EC230, 4), x86::reg32(0x404800));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7881B4));
	mov(mv, x86::mem(0x7EC220, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7881A4));
	mov(mv, x86::mem(0x7EC224, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7EC23C, 4), x86::reg32(0x78819C));
	mov(mv, x86::mem(0x7EC240, 4), x86::reg32(0x441C80));
	mov(mv, x86::mem(0x7EC244, 4), x86::reg32(0x441D00));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x78819C));
	mov(mv, x86::mem(0x7EC234, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x78818C));
	mov(mv, x86::mem(0x7EC238, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7EC250, 4), x86::reg32(0x788184));
	mov(mv, x86::mem(0x7EC254, 4), x86::reg32(0x441D30));
	mov(mv, x86::mem(0x7EC258, 4), x86::reg32(0x404800));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x788184));
	mov(mv, x86::mem(0x7EC248, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x788174));
	mov(mv, x86::mem(0x7EC24C, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7EC264, 4), x86::reg32(0x788168));
	mov(mv, x86::mem(0x7EC268, 4), x86::reg32(0x441E90));
	mov(mv, x86::mem(0x7EC26C, 4), x86::reg32(0x441F40));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x788168));
	mov(mv, x86::mem(0x7EC25C, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x30));
	mov(mv, x86::mem(0x7EC260, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77B840(x86::thread_state* ts, x86::memory_view* mv) {
	mov(mv, &ts->eax, x86::mem(0x786FBC, 4));
	mov(mv, x86::mem(0x8286E0, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}
...
void sub_77B990(x86::thread_state* ts, x86::memory_view* mv) {
	...
	mov(mv, x86::mem(0x828724, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}
...
void sub_77B9B0(x86::thread_state* ts, x86::memory_view* mv) {
	...
	mov(mv, x86::mem(0x82A4EC, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}
...
void sub_77B9E0(x86::thread_state* ts, x86::memory_view* mv) {
	...
	game::__ftol2(ts, mv);
	mov(mv, x86::mem(0x82A47C, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}
...
void sub_77BA00(x86::thread_state* ts, x86::memory_view* mv) {
	...
	game::__ftol2(ts, mv);
	mov(mv, x86::mem(0x82873C, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}
...
void sub_77BA30(x86::thread_state* ts, x86::memory_view* mv) {
	...
	fsubp(&ts->fp, x86::fp_index(1), x86::fp_index(0));
	game::__ftol2(ts, mv);
	mov(mv, x86::mem(0x828718, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}
...
void sub_77BA60(x86::thread_state* ts, x86::memory_view* mv) {
	...
	mov(mv, x86::mem(0x82A44C, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}
...
void sub_77BA90(x86::thread_state* ts, x86::memory_view* mv) {
	...
	game::__ftol2(ts, mv);
	fstp(&ts->fp, x86::fp_index(0), x86::fp_index(0));
	mov(mv, x86::mem(0x8286F0, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}
...
void sub_77BAC0(x86::thread_state* ts, x86::memory_view* mv) {
	...
	fsubp(&ts->fp, x86::fp_index(1), x86::fp_index(0));
	game::__ftol2(ts, mv);
	mov(mv, x86::mem(0x82A4D8, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}
...
void sub_77BAF0(x86::thread_state* ts, x86::memory_view* mv) {
	...
	fsubp(&ts->fp, x86::fp_index(1), x86::fp_index(0));
	game::__ftol2(ts, mv);
	mov(mv, x86::mem(0x82A474, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}
...
void sub_77BB20(x86::thread_state* ts, x86::memory_view* mv) {
	...
	game::__ftol2(ts, mv);
	mov(mv, x86::mem(0x828738, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}
...
void sub_77BB40(x86::thread_state* ts, x86::memory_view* mv) {
	...
	game::__ftol2(ts, mv);
	mov(mv, x86::mem(0x828728, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}
...
void sub_77BB60(x86::thread_state* ts, x86::memory_view* mv) {
	...
	game::__ftol2(ts, mv);
	mov(mv, x86::mem(0x828758, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}
...
void sub_77BB80(x86::thread_state* ts, x86::memory_view* mv) {
	...
	fmul(mv, &ts->fp, x86::fp_index(0), x86::mem(0x7881F8, 4));
	game::__ftol2(ts, mv);
	mov(mv, x86::mem(0x828748, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}
...
void sub_77BBA0(x86::thread_state* ts, x86::memory_view* mv) {
	...
	game::__ftol2(ts, mv);
	mov(mv, x86::mem(0x828754, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}
...
void sub_77BBC0(x86::thread_state* ts, x86::memory_view* mv) {
	...
	game::__ftol2(ts, mv);
	mov(mv, x86::mem(0x82A470, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}
...
void sub_77BBE0(x86::thread_state* ts, x86::memory_view* mv) {
	...
	game::__ftol2(ts, mv);
	mov(mv, x86::mem(0x82A460, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}
...
void sub_77BC00(x86::thread_state* ts, x86::memory_view* mv) {
	...
	game::__ftol2(ts, mv);
	mov(mv, x86::mem(0x82872C, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}
...
void sub_77BC20(x86::thread_state* ts, x86::memory_view* mv) {
	...
	fmul(mv, &ts->fp, x86::fp_index(0), x86::mem(0x7881F8, 4));
	game::__ftol2(ts, mv);
	mov(mv, x86::mem(0x82A46C, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}
...
void sub_77BC40(x86::thread_state* ts, x86::memory_view* mv) {
	...
	fmul(mv, &ts->fp, x86::fp_index(0), x86::mem(0x787ADC, 4));
	game::__ftol2(ts, mv);
	mov(mv, x86::mem(0x82A45C, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}
...
void sub_77BC60(x86::thread_state* ts, x86::memory_view* mv) {
	...
	game::__ftol2(ts, mv);
	mov(mv, x86::mem(0x8286F8, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}
...
void sub_77BC80(x86::thread_state* ts, x86::memory_view* mv) {
	...
	fmul(mv, &ts->fp, x86::fp_index(0), x86::mem(0x7D7D3C, 4));
	game::__ftol2(ts, mv);
	mov(mv, x86::mem(0x8286E4, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}
...
void sub_77BCA0(x86::thread_state* ts, x86::memory_view* mv) {
	...
	game::__ftol2(ts, mv);
	mov(mv, x86::mem(0x828740, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}
...
void sub_77BCC0(x86::thread_state* ts, x86::memory_view* mv) {
	...
	game::__ftol2(ts, mv);
	mov(mv, x86::mem(0x828714, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}
...
void sub_77BCE0(x86::thread_state* ts, x86::memory_view* mv) {
	...
	game::__ftol2(ts, mv);
	mov(mv, x86::mem(0x828720, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}
...
void sub_77BD00(x86::thread_state* ts, x86::memory_view* mv) {
	...
	game::__ftol2(ts, mv);
	mov(mv, x86::mem(0x82A4D4, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}
...
void sub_77BD20(x86::thread_state* ts, x86::memory_view* mv) {
	fld(mv, &ts->fp, x86::fp_index(0), x86::mem(0x786FC0, 4));
	game::__ftol2(ts, mv);
	mov(mv, x86::mem(0x8286EC, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}
...
void sub_77BD40(x86::thread_state* ts, x86::memory_view* mv) {
	...
	game::__ftol2(ts, mv);
	mov(mv, x86::mem(0x82A478, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}
...
void sub_77BD60(x86::thread_state* ts, x86::memory_view* mv) {
	...
	fmul(mv, &ts->fp, x86::fp_index(0), x86::mem(0x784D28, 4));
	game::__ftol2(ts, mv);
	mov(mv, x86::mem(0x828744, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77BD80(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x828770));
	game::sub_447C40(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781BB0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77BE00(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x2));
	push(mv, &ts->esp, x86::reg32(0x7EC420));
	mov(&ts->ecx, x86::reg32(0x82A4E0));
	game::sub_576770(ts, mv);
	retn(mv, &ts->esp);
}
...
void sub_77BE20(x86::thread_state* ts, x86::memory_view* mv) {
	...
	push(mv, &ts->esp, x86::reg32(0x3DCCCCCD));
	fmul(mv, &ts->fp, x86::fp_index(0), x86::mem(0x787B5C, 4));
	push(mv, &ts->esp, x86::reg32(0x3CF5C28F));
	push(mv, &ts->esp, x86::reg32(0x0));
	push(mv, &ts->esp, x86::reg32(ts->ecx));
	mov(&ts->ecx, x86::reg32(0x8286FC));
	fstp(mv, &ts->fp, x86::fp_index(0), x86::mem(ts->esp, 4));
	game::sub_446690(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781BA0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77BEA0(x86::thread_state* ts, x86::memory_view* mv) {
	...
	add(&ts->edx, x86::reg32(ts->ecx));
	mov(mv, &ts->ecx, x86::mem(0x7ED914, 4));
	add(&ts->edx, x86::reg32(ts->eax));
	...
	add(&ts->edx, x86::reg32(ts->ecx));
	add(&ts->edx, x86::reg32(ts->eax));
	mov(mv, x86::mem(0x82BF30, 4), x86::reg32(ts->edx));
	retn(mv, &ts->esp);
}
...
void sub_77BF20(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x5));
	mov(&ts->ecx, x86::reg32(0x82C6E8));
	game::sub_579F20(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781BC0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77BF40(x86::thread_state* ts, x86::memory_view* mv) {
	...
	fnstsw(&ts->fp, x86::reg16(ts->ax));
	test(&ts->eflags, x86::reg8(ts->ah), x86::reg8(0x5));
	if (ts->eflags.parity) {
        goto loc_77BF5F;
    }
	mov(mv, x86::mem(0x7F0008, 4), x86::reg32(0x3F800008));

loc_77BF5F:
	push(mv, &ts->esp, x86::reg32(0x781CA0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77BF70(x86::thread_state* ts, x86::memory_view* mv) {
	...
	mov(mv, x86::mem(0x7F0024, 4), x86::reg32(0x42C80000));

loc_77BF8F:
	push(mv, &ts->esp, x86::reg32(0x781CB0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77BFA0(x86::thread_state* ts, x86::memory_view* mv) {
	...
	mov(mv, x86::mem(0x7F0038, 4), x86::reg32(ts->eax));
	...
	mov(mv, x86::mem(0x7F0040, 4), x86::reg32(0x42FE0000));

loc_77BFDB:
	push(mv, &ts->esp, x86::reg32(0x781CC0));
...
void sub_77BFF0(x86::thread_state* ts, x86::memory_view* mv) {
	...
	mov(mv, x86::mem(0x82BCD0, 4), x86::reg32(ts->eax));
	mov(mv, &ts->eax, x86::mem(0x7884A0, 4));
	mov(mv, x86::mem(0x82BCDC, 4), x86::reg32(ts->eax));
	fld(mv, &ts->fp, x86::fp_index(0), x86::mem(0x82BCDC, 4));
	mov(mv, x86::mem(0x82BCD8, 4), x86::reg32(ts->edx));
	fsub(mv, &ts->fp, x86::fp_index(0), x86::mem(0x82BCD8, 4));
	mov(mv, x86::mem(0x82BCD4, 4), x86::reg32(ts->ecx));
	fabs(&ts->fp, x86::fp_index(0));
	fcomp(mv, &ts->fp, x86::fp_index(0), x86::mem(0x787594, 4));
	fnstsw(&ts->fp, x86::reg16(ts->ax));
	test(&ts->eflags, x86::reg8(ts->ah), x86::reg8(0x5));
...
loc_77C049:
	...
	push(mv, &ts->esp, x86::reg32(0x781CD0));
	mov(mv, x86::mem(0x82BCE4, 4), x86::reg32(ts->ecx));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77C070(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x781CE0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77C080(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x781CF0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77C090(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x781D00));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77C0A0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x781D10));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77C0B0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x781D20));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77C0C0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x82C694));
	game::sub_468ED0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781BD0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77C0E0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(ts->esi));
	push(mv, &ts->esp, x86::reg32(ts->edi));
	mov(&ts->esi, x86::reg32(0x82BF48));
	mov(&ts->edi, x86::reg32(0xD));
	lea(mv, &ts->esp, x86::mem(ts->esp, 4));

loc_77C0F0:
	mov(&ts->ecx, x86::reg32(ts->esi));
	game::sub_458F80(ts, mv);
	add(&ts->esi, x86::reg32(0x70));
	dec(&ts->edi);
	if (!ts->eflags.zero) {
        goto loc_77C0F0;
    }
...
void sub_77C100(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x78C250));
	mov(&ts->ecx, x86::reg32(0x82C710));
	game::sub_60B780(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781BE0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77C120(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x78C25C));
	mov(&ts->ecx, x86::reg32(0x82BEA0));
	game::sub_60B780(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781BF0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void unknown_libname_94(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x82C570));
	goto loc_734DA0;

loc_734DA0:
	mov(&ts->eax, x86::reg32(ts->ecx));
	mov(mv, x86::mem(ts->eax + 0x4, 4), x86::reg32(0xFFFFFFFD));
	retn(mv, &ts->esp);
}

void unknown_libname_95(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x82C578));
	goto loc_734DA0;
...
void sub_77C220(x86::thread_state* ts, x86::memory_view* mv) {
	...
	mov(&ts->ecx, x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7F38A8, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7F38AC, 4), x86::reg32(ts->ecx));
	mov(mv, &ts->ecx, x86::mem(0x788598, 4));
	mov(&ts->eax, x86::reg32(ts->edx));
	mov(mv, x86::mem(0x7F38E0, 4), x86::reg32(ts->edx));
	mov(&ts->edx, x86::reg32(ts->ecx));
	mov(mv, x86::mem(0x7F38E4, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7F38E8, 4), x86::reg32(ts->ecx));
	mov(&ts->cl, x86::reg8(0x80));
	mov(&ts->al, x86::reg8(0x25));
	mov(mv, x86::mem(0x7F3908, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7F3909, 1), x86::reg8(ts->al));
	xor_(&ts->eax, x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7F390E, 1), x86::reg8(ts->cl));
	mov(mv, x86::mem(0x7F390F, 1), x86::reg8(ts->cl));
	mov(mv, x86::mem(0x7F3910, 1), x86::reg8(ts->cl));
	mov(mv, x86::mem(0x7F3911, 1), x86::reg8(ts->cl));
	mov(mv, x86::mem(0x7F3912, 1), x86::reg8(ts->cl));
	mov(mv, x86::mem(0x7F3913, 1), x86::reg8(ts->cl));
	mov(&ts->cl, x86::reg8(0x32));
	mov(mv, x86::mem(0x7F38B0, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7F38B4, 4), x86::reg32(0x41200000));
	mov(mv, x86::mem(0x7F38B8, 4), x86::reg32(0x40000000));
	mov(mv, x86::mem(0x7F38BC, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7F38C0, 4), x86::reg32(0x41200000));
	mov(mv, x86::mem(0x7F38C4, 4), x86::reg32(0x40000000));
	mov(mv, x86::mem(0x7F38C8, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7F38CC, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7F38D0, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7F38D4, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7F38D8, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7F38DC, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7F38EC, 4), x86::reg32(ts->edx));
	mov(mv, x86::mem(0x7F38F0, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7F38F4, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7F38F8, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7F38FC, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7F3900, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7F3904, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7F390A, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7F390B, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7F390C, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7F390D, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7F3914, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7F3915, 1), x86::reg8(ts->cl));
	mov(mv, x86::mem(0x7F3916, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7F3917, 1), x86::reg8(ts->cl));
	mov(mv, x86::mem(0x7F3918, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7F3919, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7F391C, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77C380(x86::thread_state* ts, x86::memory_view* mv) {
	mov(mv, &ts->eax, x86::mem(0x788604, 4));
	mov(mv, x86::mem(0x7F005C, 4), x86::reg32(ts->eax));
...
loc_77C3B7:
	push(mv, &ts->esp, x86::reg32(0x781C00));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77C3D0(x86::thread_state* ts, x86::memory_view* mv) {
	...
	mov(mv, x86::mem(0x7F0968, 4), x86::reg32(0x45DAC000));

loc_77C3EF:
	push(mv, &ts->esp, x86::reg32(0x781C10));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77C400(x86::thread_state* ts, x86::memory_view* mv) {
	...
	mov(mv, x86::mem(0x7F0984, 4), x86::reg32(0x42700000));

loc_77C41F:
	push(mv, &ts->esp, x86::reg32(0x781C20));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77C430(x86::thread_state* ts, x86::memory_view* mv) {
	...
	mov(mv, x86::mem(0x7F09A0, 4), x86::reg32(0x42700000));

loc_77C44F:
	push(mv, &ts->esp, x86::reg32(0x781C30));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77C460(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x5));
	push(mv, &ts->esp, x86::reg32(0x7F09B0));
	mov(&ts->ecx, x86::reg32(0x82C69C));
	game::sub_576770(ts, mv);
	retn(mv, &ts->esp);
}
...
void sub_77C480(x86::thread_state* ts, x86::memory_view* mv) {
	...
	fabs(&ts->fp, x86::fp_index(0));
	fcomp(mv, &ts->fp, x86::fp_index(0), x86::mem(0x787594, 4));
	mov(mv, x86::mem(0x7F09D8, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7F09DC, 4), x86::reg32(ts->ecx));
	fnstsw(&ts->fp, x86::reg16(ts->ax));
	test(&ts->eflags, x86::reg8(ts->ah), x86::reg8(0x5));
	if (ts->eflags.parity) {
        goto loc_77C4B5;
    }
	mov(mv, x86::mem(0x7F09E4, 4), x86::reg32(0x42C80000));

loc_77C4B5:
	mov(mv, &ts->edx, x86::mem(0x788818, 4));
	push(mv, &ts->esp, x86::reg32(0x781C40));
	mov(mv, x86::mem(0x7F09EC, 4), x86::reg32(ts->edx));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77C4D0(x86::thread_state* ts, x86::memory_view* mv) {
	...
	mov(mv, x86::mem(0x7F0A00, 4), x86::reg32(ts->eax));
...
loc_77C501:
	push(mv, &ts->esp, x86::reg32(0x781C50));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77C510(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x78C298));
	push(mv, &ts->esp, x86::reg32(0x7F0A1C));
	game::sub_43DBD0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x78C28C));
	push(mv, &ts->esp, x86::reg32(0x7F0A68));
	mov(mv, x86::mem(0x7F0A5C, 4), x86::reg32(0x42280000));
	mov(mv, x86::mem(0x7F0A60, 4), x86::reg32(0x20));
	mov(mv, x86::mem(0x7F0A64, 4), x86::reg32(0x41B80000));
	game::sub_43DBD0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x78C280));
	push(mv, &ts->esp, x86::reg32(0x7F0AB4));
	mov(mv, x86::mem(0x7F0AA8, 4), x86::reg32(0x42280000));
	mov(mv, x86::mem(0x7F0AAC, 4), x86::reg32(0x20));
	mov(mv, x86::mem(0x7F0AB0, 4), x86::reg32(0x41B80000));
	game::sub_43DBD0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x78C280));
	push(mv, &ts->esp, x86::reg32(0x7F0B00));
	mov(mv, x86::mem(0x7F0AF4, 4), x86::reg32(0x42280000));
	mov(mv, x86::mem(0x7F0AF8, 4), x86::reg32(0x20));
	mov(mv, x86::mem(0x7F0AFC, 4), x86::reg32(0x41B80000));
	game::sub_43DBD0(ts, mv);
	add(&ts->esp, x86::reg32(0x20));
	retn(mv, &ts->esp);
}
...
void sub_77C5B0(x86::thread_state* ts, x86::memory_view* mv) {
	...
	mov(mv, x86::mem(0x7F0B4C, 4), x86::reg32(ts->ecx));
	fld(mv, &ts->fp, x86::fp_index(0), x86::mem(0x7F0B4C, 4));
	mov(mv, x86::mem(0x7F0B48, 4), x86::reg32(ts->eax));
...
loc_77C5F3:
	push(mv, &ts->esp, x86::reg32(0x781C60));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77C600(x86::thread_state* ts, x86::memory_view* mv) {
	...
	mov(mv, x86::mem(0x7F0B68, 4), x86::reg32(0x3F800008));

loc_77C61F:
	push(mv, &ts->esp, x86::reg32(0x781C70));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77C630(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x78C2B0));
	mov(&ts->ecx, x86::reg32(0x82C5E8));
	game::sub_60B780(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781C80));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77C650(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x82C6A4));
	game::sub_57BCD0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781D40));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77C670(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x82BEBC));
	game::sub_57BCD0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781D30));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77C690(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x82BEC4));
	game::sub_57BCD0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781D50));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77C8A0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x830D08));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781DA0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77C8C0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x835860));
	game::sub_494650(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781E80));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77C8E0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x8357E0));
	game::sub_494650(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781E20));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77C900(x86::thread_state* ts, x86::memory_view* mv) {
	...
	mov(&ts->ecx, x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7F4240, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7F4244, 4), x86::reg32(ts->ecx));
	mov(mv, &ts->ecx, x86::mem(0x78D774, 4));
	mov(&ts->eax, x86::reg32(ts->edx));
	mov(mv, x86::mem(0x7F4278, 4), x86::reg32(ts->edx));
	mov(&ts->edx, x86::reg32(ts->ecx));
	mov(mv, x86::mem(0x7F427C, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7F4280, 4), x86::reg32(ts->ecx));
	mov(&ts->cl, x86::reg8(0x80));
	mov(&ts->al, x86::reg8(0x25));
	mov(mv, x86::mem(0x7F42A0, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7F42A1, 1), x86::reg8(ts->al));
	xor_(&ts->eax, x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7F42A6, 1), x86::reg8(ts->cl));
	mov(mv, x86::mem(0x7F42A7, 1), x86::reg8(ts->cl));
	mov(mv, x86::mem(0x7F42A8, 1), x86::reg8(ts->cl));
	mov(mv, x86::mem(0x7F42A9, 1), x86::reg8(ts->cl));
	mov(mv, x86::mem(0x7F42AA, 1), x86::reg8(ts->cl));
	mov(mv, x86::mem(0x7F42AB, 1), x86::reg8(ts->cl));
	mov(&ts->cl, x86::reg8(0x32));
	mov(mv, x86::mem(0x7F4248, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7F424C, 4), x86::reg32(0x41200000));
	mov(mv, x86::mem(0x7F4250, 4), x86::reg32(0x40000000));
	mov(mv, x86::mem(0x7F4254, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7F4258, 4), x86::reg32(0x41200000));
	mov(mv, x86::mem(0x7F425C, 4), x86::reg32(0x40000000));
	mov(mv, x86::mem(0x7F4260, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7F4264, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7F4268, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7F426C, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7F4270, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7F4274, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7F4284, 4), x86::reg32(ts->edx));
	mov(mv, x86::mem(0x7F4288, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7F428C, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7F4290, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7F4294, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7F4298, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7F429C, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7F42A2, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7F42A3, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7F42A4, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7F42A5, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7F42AC, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7F42AD, 1), x86::reg8(ts->cl));
	mov(mv, x86::mem(0x7F42AE, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7F42AF, 1), x86::reg8(ts->cl));
	mov(mv, x86::mem(0x7F42B0, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7F42B1, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7F42B4, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77CA60(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x82DBC0));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781E30));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77CA80(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x832DA4));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781E40));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77CAA0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x830D1C));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781EB0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77CAC0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x835858));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781EC0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77CAE0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x835794));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781ED0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77CB00(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x4940E0));
	push(mv, &ts->esp, x86::reg32(0x494060));
	push(mv, &ts->esp, x86::reg32(0x80134000));
	mov(&ts->ecx, x86::reg32(0x835840));
	game::sub_43C0B0(ts, mv);
	retn(mv, &ts->esp);
}

void sub_77CB20(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x494210));
	push(mv, &ts->esp, x86::reg32(0x48DA00));
	push(mv, &ts->esp, x86::reg32(0x48B410));
	push(mv, &ts->esp, x86::reg32(0x494190));
	push(mv, &ts->esp, x86::reg32(0x494140));
	push(mv, &ts->esp, x86::reg32(0x80));
	mov(&ts->ecx, x86::reg32(0x82DBC8));
	game::sub_493390(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781DB0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77CB60(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x830C78));
	game::sub_494960(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781E90));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77CB80(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x781D60));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77CB90(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x830D30));
	game::sub_494230(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781E50));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77CBB0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x830AE8));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781EA0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77CBD0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x830D14));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781E60));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77CBF0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x8358C0));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781DC0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77CC10(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x781D70));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77CC20(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x48E270));
	push(mv, &ts->esp, x86::reg32(0x48E070));
	push(mv, &ts->esp, x86::reg32(0x135200));
	mov(&ts->ecx, x86::reg32(0x835784));
	game::sub_43C0B0(ts, mv);
	retn(mv, &ts->esp);
}
...
void sub_77CC40(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x48E270));
	push(mv, &ts->esp, x86::reg32(0x48E070));
	push(mv, &ts->esp, x86::reg32(0x80135100));
	mov(&ts->ecx, x86::reg32(0x830AF8));
	game::sub_43C0B0(ts, mv);
	retn(mv, &ts->esp);
}
...
void sub_77CC60(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x48E270));
	push(mv, &ts->esp, x86::reg32(0x48E070));
	push(mv, &ts->esp, x86::reg32(0x80135000));
	mov(&ts->ecx, x86::reg32(0x82DBB0));
	game::sub_43C0B0(ts, mv);
	retn(mv, &ts->esp);
}

void sub_77CC80(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x835850));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781EE0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77CCA0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x4022C0));
	push(mv, &ts->esp, x86::reg32(0x502FD0));
	push(mv, &ts->esp, x86::reg32(0xFA));
	push(mv, &ts->esp, x86::reg32(0x30));
	push(mv, &ts->esp, x86::reg32(0x82DC08));
	game::sub_75C461(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781D80));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77CCD0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x4919D0));
	push(mv, &ts->esp, x86::reg32(0x491940));
	push(mv, &ts->esp, x86::reg32(0x16));
	push(mv, &ts->esp, x86::reg32(0x70));
	push(mv, &ts->esp, x86::reg32(0x832DE0));
	game::sub_75C461(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781DD0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77CD00(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x830AF0));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781DF0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77CD20(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x82DC00));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781E00));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77CD40(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x8358C8));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781E70));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77CD60(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x495040));
	push(mv, &ts->esp, x86::reg32(0x494EA0));
	push(mv, &ts->esp, x86::reg32(0xB3300000));
	mov(&ts->ecx, x86::reg32(0x82DBA0));
	game::sub_43C0B0(ts, mv);
	retn(mv, &ts->esp);
}
...
void sub_77CD80(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x495040));
	push(mv, &ts->esp, x86::reg32(0x494EA0));
	push(mv, &ts->esp, x86::reg32(0xB3320000));
	mov(&ts->ecx, x86::reg32(0x8358D0));
	game::sub_43C0B0(ts, mv);
	retn(mv, &ts->esp);
}
...
void sub_77CDA0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x495040));
	push(mv, &ts->esp, x86::reg32(0x494EA0));
	push(mv, &ts->esp, x86::reg32(0xB0300100));
	mov(&ts->ecx, x86::reg32(0x830B08));
	game::sub_43C0B0(ts, mv);
	retn(mv, &ts->esp);
}

void sub_77CDC0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x4950D0));
	push(mv, &ts->esp, x86::reg32(0x494500));
	push(mv, &ts->esp, x86::reg32(0x48B410));
	push(mv, &ts->esp, x86::reg32(0x494C80));
	push(mv, &ts->esp, x86::reg32(0x494C10));
	push(mv, &ts->esp, x86::reg32(0x80));
	mov(&ts->ecx, x86::reg32(0x83579C));
	game::sub_493390(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781E10));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77CE20(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x4957A0));
	push(mv, &ts->esp, x86::reg32(0x4FF430));
	push(mv, &ts->esp, x86::reg32(0x7));
	push(mv, &ts->esp, x86::reg32(0x44));
	push(mv, &ts->esp, x86::reg32(0x836568));
	game::sub_75C461(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781EF0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77CE50(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0xC8CFE9F2));
	mov(&ts->ecx, x86::reg32(0x837188));
	game::sub_5054A0(ts, mv);
	retn(mv, &ts->esp);
}

void sub_77CE60(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0xFFFFFFFF));
	mov(&ts->ecx, x86::reg32(0x837198));
	game::sub_5054A0(ts, mv);
	retn(mv, &ts->esp);
}

void sub_77CE70(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x50549AC0));
	mov(&ts->ecx, x86::reg32(0x836550));
	game::sub_5054A0(ts, mv);
	retn(mv, &ts->esp);
}

void sub_77CE80(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0xFF323232));
	mov(&ts->ecx, x86::reg32(0x837178));
	game::sub_5054A0(ts, mv);
	retn(mv, &ts->esp);
}

void sub_77CE90(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x8364F4));
	game::sub_510920(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781F10));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77CEB0(x86::thread_state* ts, x86::memory_view* mv) {
	...
	mov(&ts->ecx, x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7F6900, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7F6904, 4), x86::reg32(ts->ecx));
	mov(mv, &ts->ecx, x86::mem(0x78DFF8, 4));
	mov(&ts->eax, x86::reg32(ts->edx));
	mov(mv, x86::mem(0x7F6938, 4), x86::reg32(ts->edx));
	mov(&ts->edx, x86::reg32(ts->ecx));
	mov(mv, x86::mem(0x7F693C, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7F6940, 4), x86::reg32(ts->ecx));
	mov(&ts->cl, x86::reg8(0x80));
	mov(&ts->al, x86::reg8(0x25));
	mov(mv, x86::mem(0x7F6960, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7F6961, 1), x86::reg8(ts->al));
	xor_(&ts->eax, x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7F6966, 1), x86::reg8(ts->cl));
	mov(mv, x86::mem(0x7F6967, 1), x86::reg8(ts->cl));
	mov(mv, x86::mem(0x7F6968, 1), x86::reg8(ts->cl));
	mov(mv, x86::mem(0x7F6969, 1), x86::reg8(ts->cl));
	mov(mv, x86::mem(0x7F696A, 1), x86::reg8(ts->cl));
	mov(mv, x86::mem(0x7F696B, 1), x86::reg8(ts->cl));
	mov(&ts->cl, x86::reg8(0x32));
	mov(mv, x86::mem(0x7F6908, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7F690C, 4), x86::reg32(0x41200000));
	mov(mv, x86::mem(0x7F6910, 4), x86::reg32(0x40000000));
	mov(mv, x86::mem(0x7F6914, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7F6918, 4), x86::reg32(0x41200000));
	mov(mv, x86::mem(0x7F691C, 4), x86::reg32(0x40000000));
	mov(mv, x86::mem(0x7F6920, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7F6924, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7F6928, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7F692C, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7F6930, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7F6934, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7F6944, 4), x86::reg32(ts->edx));
	mov(mv, x86::mem(0x7F6948, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7F694C, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7F6950, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7F6954, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7F6958, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7F695C, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7F6962, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7F6963, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7F6964, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7F6965, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7F696C, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7F696D, 1), x86::reg8(ts->cl));
	mov(mv, x86::mem(0x7F696E, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7F696F, 1), x86::reg8(ts->cl));
	mov(mv, x86::mem(0x7F6970, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7F6971, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7F6974, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77D010(x86::thread_state* ts, x86::memory_view* mv) {
	mov(mv, &ts->eax, x86::mem(0x78E024, 4));
	mov(&ts->ecx, x86::reg32(0x1));
	mov(mv, x86::mem(0x7F6BB0, 4), x86::reg32(ts->eax));
	xor_(&ts->eax, x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7F6BB4, 4), x86::reg32(0x3E800000));
	mov(mv, x86::mem(0x7F6BB8, 4), x86::reg32(0xBDCCCCCD));
	mov(mv, x86::mem(0x7F6BBC, 4), x86::reg32(0x41200000));
	mov(mv, x86::mem(0x7F6BC0, 4), x86::reg32(ts->ecx));
	mov(mv, x86::mem(0x7F6BC4, 4), x86::reg32(ts->ecx));
	mov(mv, x86::mem(0x7F6BC8, 4), x86::reg32(0x3F000000));
	mov(mv, x86::mem(0x7F6BCC, 4), x86::reg32(0x40100000));
	mov(mv, x86::mem(0x7F6BD0, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7F6BD4, 4), x86::reg32(0x3ECCCCCD));
	mov(mv, x86::mem(0x7F6BD8, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7F6BDC, 4), x86::reg32(0x3F800000));
	mov(mv, x86::mem(0x7F6BE0, 4), x86::reg32(0x40533333));
	mov(mv, x86::mem(0x7F6BE4, 4), x86::reg32(0x42200000));
	mov(mv, x86::mem(0x7F6BE8, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7F6BEC, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7F6BF0, 4), x86::reg32(0x3F800000));
	mov(mv, x86::mem(0x7F6BF4, 4), x86::reg32(0x3ECCCCCD));
	mov(mv, x86::mem(0x7F6BF8, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7F6BFC, 4), x86::reg32(0xBF800000));
	mov(mv, x86::mem(0x7F6C00, 4), x86::reg32(ts->ecx));
	mov(mv, x86::mem(0x7F6C04, 4), x86::reg32(0x3F000000));
	mov(mv, x86::mem(0x7F6C08, 4), x86::reg32(0x40100000));
	mov(mv, x86::mem(0x7F6C0C, 4), x86::reg32(0x41880000));
	mov(mv, x86::mem(0x7F6C10, 4), x86::reg32(0x3ECCCCCD));
	mov(mv, x86::mem(0x7F6C14, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7F6C18, 4), x86::reg32(0x3F800000));
	mov(mv, x86::mem(0x7F6C1C, 4), x86::reg32(0x40000000));
	mov(mv, x86::mem(0x7F6C20, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7F6C24, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7F6C28, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7F6C2C, 4), x86::reg32(0x3F800000));
	mov(mv, x86::mem(0x7F6C30, 4), x86::reg32(0x3ECCCCCD));
	mov(mv, x86::mem(0x7F6C34, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7F6C38, 4), x86::reg32(0xBF800000));
	mov(mv, x86::mem(0x7F6C3C, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7F6C40, 4), x86::reg32(0x3F000000));
	mov(mv, x86::mem(0x7F6C44, 4), x86::reg32(0x40100000));
	mov(mv, x86::mem(0x7F6C48, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7F6C4C, 4), x86::reg32(0x3ECCCCCD));
	mov(mv, x86::mem(0x7F6C50, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7F6C54, 4), x86::reg32(0x3F800000));
	mov(mv, x86::mem(0x7F6C58, 4), x86::reg32(0x4007DF3B));
	mov(mv, x86::mem(0x7F6C5C, 4), x86::reg32(0x42200000));
	mov(mv, x86::mem(0x7F6C60, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7F6C64, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7F6C68, 4), x86::reg32(0xBF800000));
	mov(mv, x86::mem(0x7F6C6C, 4), x86::reg32(0x3ECCCCCD));
	mov(mv, x86::mem(0x7F6C70, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7F6C74, 4), x86::reg32(0xBF800000));
	mov(mv, x86::mem(0x7F6C78, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7F6C7C, 4), x86::reg32(0x3F000000));
	mov(mv, x86::mem(0x7F6C80, 4), x86::reg32(0x40100000));
	mov(mv, x86::mem(0x7F6C84, 4), x86::reg32(0x41880000));
	mov(mv, x86::mem(0x7F6C88, 4), x86::reg32(0x3ECCCCCD));
	mov(mv, x86::mem(0x7F6C8C, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7F6C90, 4), x86::reg32(0x3F800000));
	mov(mv, x86::mem(0x7F6C94, 4), x86::reg32(0x40000000));
	mov(mv, x86::mem(0x7F6C98, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7F6C9C, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7F6CA0, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7F6CA4, 4), x86::reg32(0xBF800000));
	mov(mv, x86::mem(0x7F6CA8, 4), x86::reg32(0x3ECCCCCD));
	mov(mv, x86::mem(0x7F6CAC, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7F6CB0, 4), x86::reg32(0xBF800000));
	retn(mv, &ts->esp);
}

void sub_77D230(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x8371B0));
	game::sub_40C910(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781F20));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77D250(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x836750));
	game::sub_40C910(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781F30));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77D270(x86::thread_state* ts, x86::memory_view* mv) {
	...
	push(mv, &ts->esp, x86::reg32(ts->esi));
	push(mv, &ts->esp, x86::reg32(ts->edi));
	mov(&ts->esi, x86::reg32(0x837048));
	mov(&ts->ebx, x86::reg32(0x6));
	or_(&ts->edi, x86::reg32(0xFFFFFFFF));

loc_77D280:
	push(mv, &ts->esp, x86::reg32(0x783FE5));
	mov(mv, x86::mem(ts->esi, 4), x86::reg32(0x0));
	lea(mv, &ts->eax, x86::mem(ts->esi + 0x4, 4));
	push(mv, &ts->esp, x86::reg32(0x20));
	push(mv, &ts->esp, x86::reg32(ts->eax));
	mov(mv, x86::mem(ts->esi - 0x8, 4), x86::reg32(ts->edi));
	mov(mv, x86::mem(ts->esi - 0x4, 4), x86::reg32(ts->edi));
	mov(mv, x86::mem(ts->esi, 4), x86::reg32(0x0));
	game::sub_50C960(ts, mv);
	mov(mv, x86::mem(ts->esi + 0x28, 4), x86::reg32(0x0));
	add(&ts->esp, x86::reg32(0xC));
	add(&ts->esi, x86::reg32(0x34));
	dec(&ts->ebx);
	if (!ts->eflags.zero) {
        goto loc_77D280;
    }
	pop(mv, &ts->esp, x86::reg32(ts->edi));
	pop(mv, &ts->esp, x86::reg32(ts->esi));
	pop(mv, &ts->esp, x86::reg32(ts->ebx));
	retn(mv, &ts->esp);
}

void sub_77D2C0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x836560));
	game::sub_57BCD0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781F40));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77D2E0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x863760));
	game::sub_4FE350(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781F50));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77D300(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x781F90));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77D340(x86::thread_state* ts, x86::memory_view* mv) {
	...
	mov(mv, x86::mem(0x839BE0, 4), x86::reg32(ts->eax));
	mov(mv, &ts->eax, x86::mem(0x7FA2BC, 4));
	mov(mv, x86::mem(0x839BE4, 4), x86::reg32(ts->ecx));
	mov(mv, x86::mem(0x839BE8, 4), x86::reg32(ts->edx));
	mov(mv, x86::mem(0x839BEC, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77D370(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x85AD40));
	game::sub_532740(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781FA0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77D390(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x83A9D0));
	game::sub_53ED20(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781FE0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77D3B0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x79DA1C));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x79DA04));
	mov(mv, x86::mem(0x8641AC, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x8641B0, 4), x86::reg32(0x4));
	mov(mv, x86::mem(0x8641B4, 4), x86::reg32(0x1));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x79D9F0));
	mov(mv, x86::mem(0x8641B8, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x8641BC, 4), x86::reg32(0x1));
	mov(mv, x86::mem(0x8641C0, 4), x86::reg32(0x2));
	game::sub_43DB50(ts, mv);
	mov(mv, x86::mem(0x8641C4, 4), x86::reg32(ts->eax));
	mov(&ts->eax, x86::reg32(0x3));
	push(mv, &ts->esp, x86::reg32(0x79D9DC));
	mov(mv, x86::mem(0x8641C8, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x8641CC, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x79D9C8));
	mov(mv, x86::mem(0x8641D0, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x8641D4, 4), x86::reg32(0x2));
	mov(mv, x86::mem(0x8641D8, 4), x86::reg32(0x4));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x79D9AC));
	mov(mv, x86::mem(0x8641DC, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x8641E0, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x8641E4, 4), x86::reg32(0xA));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x18));
	mov(mv, x86::mem(0x8641E8, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x8641EC, 4), x86::reg32(0x1));
	retn(mv, &ts->esp);
}

void sub_77D480(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x8637A0));
	game::sub_52C270(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781FF0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77D4A0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x863770));
	game::sub_52C270(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782000));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77D4C0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x839C30));
	game::sub_52C270(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782010));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77D4E0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x839BD0));
	game::sub_52C270(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782020));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77D500(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x525C50));
	push(mv, &ts->esp, x86::reg32(0x57BCD0));
	push(mv, &ts->esp, x86::reg32(0x100));
	push(mv, &ts->esp, x86::reg32(0x8));
	push(mv, &ts->esp, x86::reg32(0x8639A0));
	game::sub_75C461(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781FB0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77D530(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x8637B0));
	game::sub_52CC50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781FD0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77D550(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x863768));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782030));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77D570(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x8637BC));
	game::sub_57BCD0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782050));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77D590(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x838980));
	game::sub_53ADF0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782040));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77D5B0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x839C40));
	game::sub_522400(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781F60));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77D5F0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x8637D0));
	game::sub_5315B0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x781F80));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77D610(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x781F70));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77D640(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x4022C0));
	push(mv, &ts->esp, x86::reg32(0x56D770));
	push(mv, &ts->esp, x86::reg32(0x6));
	push(mv, &ts->esp, x86::reg32(0x20));
	push(mv, &ts->esp, x86::reg32(0x864640));
	game::sub_75C461(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782060));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77D670(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x864630));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782080));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77D690(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x865210));
	game::sub_57BCD0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782280));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77D6D0(x86::thread_state* ts, x86::memory_view* mv) {
	...
	mov(&ts->ecx, x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7FB8E8, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7FB8EC, 4), x86::reg32(ts->ecx));
	mov(mv, &ts->ecx, x86::mem(0x79DC4C, 4));
	mov(&ts->eax, x86::reg32(ts->edx));
	mov(mv, x86::mem(0x7FB920, 4), x86::reg32(ts->edx));
	mov(&ts->edx, x86::reg32(ts->ecx));
	mov(mv, x86::mem(0x7FB924, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7FB928, 4), x86::reg32(ts->ecx));
	mov(&ts->cl, x86::reg8(0x80));
	mov(&ts->al, x86::reg8(0x25));
	mov(mv, x86::mem(0x7FB948, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7FB949, 1), x86::reg8(ts->al));
	xor_(&ts->eax, x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7FB94E, 1), x86::reg8(ts->cl));
	mov(mv, x86::mem(0x7FB94F, 1), x86::reg8(ts->cl));
	mov(mv, x86::mem(0x7FB950, 1), x86::reg8(ts->cl));
	mov(mv, x86::mem(0x7FB951, 1), x86::reg8(ts->cl));
	mov(mv, x86::mem(0x7FB952, 1), x86::reg8(ts->cl));
	mov(mv, x86::mem(0x7FB953, 1), x86::reg8(ts->cl));
	mov(&ts->cl, x86::reg8(0x32));
	mov(mv, x86::mem(0x7FB8F0, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7FB8F4, 4), x86::reg32(0x41200000));
	mov(mv, x86::mem(0x7FB8F8, 4), x86::reg32(0x40000000));
	mov(mv, x86::mem(0x7FB8FC, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7FB900, 4), x86::reg32(0x41200000));
	mov(mv, x86::mem(0x7FB904, 4), x86::reg32(0x40000000));
	mov(mv, x86::mem(0x7FB908, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7FB90C, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7FB910, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7FB914, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7FB918, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7FB91C, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7FB92C, 4), x86::reg32(ts->edx));
	mov(mv, x86::mem(0x7FB930, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7FB934, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7FB938, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7FB93C, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7FB940, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7FB944, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x7FB94A, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7FB94B, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7FB94C, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7FB94D, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7FB954, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7FB955, 1), x86::reg8(ts->cl));
	mov(mv, x86::mem(0x7FB956, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7FB957, 1), x86::reg8(ts->cl));
	mov(mv, x86::mem(0x7FB958, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7FB959, 1), x86::reg8(ts->al));
	mov(mv, x86::mem(0x7FB95C, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77D830(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x8651A4));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7821F0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77D850(x86::thread_state* ts, x86::memory_view* mv) {
	...
	mov(mv, x86::mem(0x86658C, 4), x86::reg32(ts->eax));
	mov(mv, &ts->eax, x86::mem(0x7FA980, 4));
	mov(mv, x86::mem(0x866590, 4), x86::reg32(ts->ecx));
	mov(mv, &ts->ecx, x86::mem(0x7FA984, 4));
	mov(mv, x86::mem(0x866594, 4), x86::reg32(ts->edx));
	mov(mv, &ts->edx, x86::mem(0x7FA988, 4));
	mov(mv, x86::mem(0x866598, 4), x86::reg32(ts->eax));
	mov(mv, &ts->eax, x86::mem(0x7FA98C, 4));
	mov(mv, x86::mem(0x86659C, 4), x86::reg32(ts->ecx));
	mov(mv, &ts->ecx, x86::mem(0x7FA990, 4));
	mov(mv, x86::mem(0x8665A0, 4), x86::reg32(ts->edx));
	mov(mv, &ts->edx, x86::mem(0x7FA994, 4));
	mov(mv, x86::mem(0x8665A4, 4), x86::reg32(ts->eax));
	mov(mv, &ts->eax, x86::mem(0x7FA998, 4));
	mov(mv, x86::mem(0x8665A8, 4), x86::reg32(ts->ecx));
	mov(mv, &ts->ecx, x86::mem(0x7FA978, 4));
	mov(mv, x86::mem(0x8665AC, 4), x86::reg32(ts->edx));
	mov(mv, x86::mem(0x8665B0, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x8665B4, 4), x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}

void sub_77D8D0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x782090));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77D8E0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x78C13C));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x4));
	mov(mv, x86::mem(0x865598, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77D900(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x86519C));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782200));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77D920(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x86555C));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782220));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77D940(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x865564));
	game::sub_57AFA0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782230));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77D960(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x579350));
	push(mv, &ts->esp, x86::reg32(0x579340));
	push(mv, &ts->esp, x86::reg32(0x39100));
	mov(&ts->ecx, x86::reg32(0x86596C));
	game::sub_43C0B0(ts, mv);
	retn(mv, &ts->esp);
}
...
void sub_77D980(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x579350));
	push(mv, &ts->esp, x86::reg32(0x579340));
	push(mv, &ts->esp, x86::reg32(0x39101));
	mov(&ts->ecx, x86::reg32(0x8653A0));
	game::sub_43C0B0(ts, mv);
	retn(mv, &ts->esp);
}
...
void sub_77D9A0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x579350));
	push(mv, &ts->esp, x86::reg32(0x579340));
	push(mv, &ts->esp, x86::reg32(0x39102));
	mov(&ts->ecx, x86::reg32(0x865470));
	game::sub_43C0B0(ts, mv);
	retn(mv, &ts->esp);
}

void sub_77D9C0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x57C320));
	push(mv, &ts->esp, x86::reg32(0x57C240));
	push(mv, &ts->esp, x86::reg32(0x2));
	push(mv, &ts->esp, x86::reg32(0x1C8));
	push(mv, &ts->esp, x86::reg32(0x8655A0));
	game::sub_75C461(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782290));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77D9F0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7820A0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77DA00(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7820B0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77DA10(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7820C0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77DA20(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7820D0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77DA30(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7820E0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77DA40(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7820F0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77DA50(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x782100));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77DA60(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x782110));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77DA70(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x782120));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77DA80(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x782130));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77DA90(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x782140));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77DAA0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x782150));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77DAB0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x782160));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77DAC0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x782170));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77DAD0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x782180));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77DAE0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(ts->edi));
	mov(&ts->ecx, x86::reg32(0x18));
	xor_(&ts->eax, x86::reg32(ts->eax));
	mov(&ts->edi, x86::reg32(0x8651B0));
	stos(mv, x86::mem(ts->edi, 4), x86::reg32(ts->eax));
	pop(mv, &ts->esp, x86::reg32(ts->edi));
	retn(mv, &ts->esp);
}
...
void sub_77DB00(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x4022C0));
	push(mv, &ts->esp, x86::reg32(0x572340));
	push(mv, &ts->esp, x86::reg32(0x4));
	push(mv, &ts->esp, x86::reg32(0x30));
	push(mv, &ts->esp, x86::reg32(0x8653B0));
	game::sub_75C461(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782190));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77DB30(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x4022C0));
	push(mv, &ts->esp, x86::reg32(0x5796D0));
	push(mv, &ts->esp, x86::reg32(0x2));
	push(mv, &ts->esp, x86::reg32(0x20));
	push(mv, &ts->esp, x86::reg32(0x865360));
	game::sub_75C461(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7821B0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77DB60(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x865220));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782240));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77DB80(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x865550));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782250));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77DBA0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x865218));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7822B0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77DBC0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x866584));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782210));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77DBE0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x8652F0));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782260));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77DC00(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x865190));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782270));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77DC20(x86::thread_state* ts, x86::memory_view* mv) {
	...
	mov(mv, x86::mem(0x7FB8A0, 4), x86::reg32(ts->eax));
	mov(&ts->eax, x86::reg32(0x3));
	mov(mv, x86::mem(0x7FB8A4, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7FB8B0, 4), x86::reg32(ts->eax));
	xor_(&ts->eax, x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7FB8A8, 4), x86::reg32(0x8A3B24));
	mov(mv, x86::mem(0x7FB8AC, 4), x86::reg32(ts->ecx));
	mov(mv, x86::mem(0x7FB8B4, 4), x86::reg32(0x8A3B38));
	mov(mv, x86::mem(0x7FB8B8, 4), x86::reg32(ts->edx));
	mov(mv, x86::mem(0x7FB8BC, 4), x86::reg32(0x6));
	mov(mv, x86::mem(0x7FB8C0, 4), x86::reg32(0x7FB624));
	mov(mv, x86::mem(0x7FB8C4, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7FB8C8, 4), x86::reg32(0x7));
	mov(mv, x86::mem(0x7FB8CC, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x7FB8D0, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77DCA0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x865930));
	game::sub_575770(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7821D0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77DCE0(x86::thread_state* ts, x86::memory_view* mv) {
	...
	mov(mv, x86::mem(0x865558, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77DCF0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x8652F8));
	game::sub_577430(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7821E0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77DD10(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->eax, x86::reg32(0x8698DC));

loc_77DD15:
	mov(mv, x86::mem(ts->eax, 1), x86::reg8(0x0));
	add(&ts->eax, x86::reg32(0x10));
	cmp(&ts->eflags, x86::reg32(ts->eax), x86::reg32(0x86993C));
	if (ts->eflags.sign != ts->eflags.overflow) {
        goto loc_77DD15;
    }
	push(mv, &ts->esp, x86::reg32(0x7822C0));
	mov(mv, x86::mem(0x86993C, 1), x86::reg8(0x0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77DD40(x86::thread_state* ts, x86::memory_view* mv) {
	...
	inc(&ts->eax);
	mov(mv, x86::mem(0x869674, 2), x86::reg16(ts->ax));
	retn(mv, &ts->esp);
}

void sub_77DD50(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7822E0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77DD60(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7822F0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77DD70(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->eax, x86::reg32(0x8691E0));
	mov(&ts->ecx, x86::reg32(0x5));
	lea(mv, &ts->ebx, x86::mem(ts->ebx, 4));

loc_77DD80:
	mov(mv, x86::mem(ts->eax, 4), x86::reg32(0x0));
	add(&ts->eax, x86::reg32(0x14));
	dec(&ts->ecx);
	if (!ts->eflags.zero) {
        goto loc_77DD80;
...
void sub_77DD90(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x782300));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77DDA0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x782310));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77DDB0(x86::thread_state* ts, x86::memory_view* mv) {
	xor_(&ts->eax, x86::reg32(ts->eax));
	mov(mv, x86::mem(0x869074, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x869078, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x86907C, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x869080, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77DDD0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x783FE5));
	push(mv, &ts->esp, x86::reg32(0x869088));
	game::sub_43DBD0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782320));
	game::_atexit(ts, mv);
	add(&ts->esp, x86::reg32(0xC));
	retn(mv, &ts->esp);
}
...
void sub_77DDF0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x782330));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77DE00(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->eax, x86::reg32(0x866C20));
	mov(&ts->edx, x86::reg32(0x12));
	xor_(&ts->ecx, x86::reg32(ts->ecx));
	lea(mv, &ts->esp, x86::mem(ts->esp, 4));

loc_77DE10:
	mov(mv, x86::mem(ts->eax - 0x1F8, 1), x86::reg8(ts->cl));
	mov(mv, x86::mem(ts->eax - 0x4, 4), x86::reg32(ts->ecx));
	mov(mv, x86::mem(ts->eax, 4), x86::reg32(ts->ecx));
	mov(mv, x86::mem(ts->eax + 0x4, 4), x86::reg32(ts->ecx));
	mov(mv, x86::mem(ts->eax + 0x8, 4), x86::reg32(ts->ecx));
	add(&ts->eax, x86::reg32(0x204));
	dec(&ts->edx);
	if (!ts->eflags.zero) {
        goto loc_77DE10;
    }
...
void sub_77DE30(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x4022C0));
	push(mv, &ts->esp, x86::reg32(0x588130));
	push(mv, &ts->esp, x86::reg32(0x5));
	push(mv, &ts->esp, x86::reg32(0x20));
	push(mv, &ts->esp, x86::reg32(0x8693C8));
	game::sub_75C461(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782340));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77DE80(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x4));
	push(mv, &ts->esp, x86::reg32(0x7FC880));
	mov(&ts->ecx, x86::reg32(0x86B3C0));
	game::sub_576770(ts, mv);
	retn(mv, &ts->esp);
}
...
void sub_77DEA0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x4));
	push(mv, &ts->esp, x86::reg32(0x7FC8A0));
	mov(&ts->ecx, x86::reg32(0x86B590));
	game::sub_576770(ts, mv);
	retn(mv, &ts->esp);
}

void sub_77DEC0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x86B4C8));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7823E0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77DEE0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x86B490));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7823F0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77DF00(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x86B5A0));
	game::sub_57BCD0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782410));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77DF20(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x86B598));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782400));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77DF40(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x3));
	push(mv, &ts->esp, x86::reg32(0x7FC8C8));
	mov(&ts->ecx, x86::reg32(0x86B578));
	game::sub_576770(ts, mv);
	retn(mv, &ts->esp);
}
...
void sub_77DF60(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x3));
	push(mv, &ts->esp, x86::reg32(0x7FC8E0));
	mov(&ts->ecx, x86::reg32(0x86B498));
	game::sub_576770(ts, mv);
	retn(mv, &ts->esp);
}

void sub_77DF80(x86::thread_state* ts, x86::memory_view* mv) {
	mov(mv, x86::mem(0x86B4A8, 4), x86::reg32(0x3DB2B8C2));
	retn(mv, &ts->esp);
}

void sub_77DF90(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x3));
	push(mv, &ts->esp, x86::reg32(0x7FC8F8));
	mov(&ts->ecx, x86::reg32(0x86B4A0));
	game::sub_576770(ts, mv);
	retn(mv, &ts->esp);
}

void __cfltcvt_init_32(x86::thread_state* ts, x86::memory_view* mv) {
	mov(mv, x86::mem(0x86B5E8, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x86B5EC, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x86B5F0, 4), x86::reg32(0x3E860A92));
	mov(mv, x86::mem(0x86B5F4, 4), x86::reg32(0x3DCCCCCD));
	mov(mv, x86::mem(0x86B5F8, 4), x86::reg32(0x3F060A92));
	mov(mv, x86::mem(0x86B5FC, 4), x86::reg32(0x3EE66666));
	mov(mv, x86::mem(0x86B600, 4), x86::reg32(0x3F490FDB));
	mov(mv, x86::mem(0x86B604, 4), x86::reg32(0x3F59999A));
	mov(mv, x86::mem(0x86B608, 4), x86::reg32(0x3F860A92));
	mov(mv, x86::mem(0x86B60C, 4), x86::reg32(0x3F733333));
	mov(mv, x86::mem(0x86B610, 4), x86::reg32(0x3FC6D3F2));
	mov(mv, x86::mem(0x86B614, 4), x86::reg32(0x3F933333));
	mov(mv, x86::mem(0x86B618, 4), x86::reg32(0x3FC90FDB));
	mov(mv, x86::mem(0x86B61C, 4), x86::reg32(0x3F800000));
	retn(mv, &ts->esp);
}

void __cfltcvt_init_33(x86::thread_state* ts, x86::memory_view* mv) {
	mov(mv, x86::mem(0x86B5B0, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x86B5B4, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x86B5B8, 4), x86::reg32(0x3E860A92));
	mov(mv, x86::mem(0x86B5BC, 4), x86::reg32(0x3DCCCCCD));
	mov(mv, x86::mem(0x86B5C0, 4), x86::reg32(0x3F060A92));
	mov(mv, x86::mem(0x86B5C4, 4), x86::reg32(0x3EE66666));
	mov(mv, x86::mem(0x86B5C8, 4), x86::reg32(0x3F490FDB));
	mov(mv, x86::mem(0x86B5CC, 4), x86::reg32(0x3F59999A));
	mov(mv, x86::mem(0x86B5D0, 4), x86::reg32(0x3F860A92));
	mov(mv, x86::mem(0x86B5D4, 4), x86::reg32(0x3F733333));
	mov(mv, x86::mem(0x86B5D8, 4), x86::reg32(0x3FC6D3F2));
	mov(mv, x86::mem(0x86B5DC, 4), x86::reg32(0x3F933333));
	mov(mv, x86::mem(0x86B5E0, 4), x86::reg32(0x3FC90FDB));
	mov(mv, x86::mem(0x86B5E4, 4), x86::reg32(0x0));
	retn(mv, &ts->esp);
}

void sub_77E0D0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(mv, x86::mem(0x86B570, 4), x86::reg32(0x86B5E8));
	mov(mv, x86::mem(0x86B574, 4), x86::reg32(0x7));
	retn(mv, &ts->esp);
}

void sub_77E0F0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(mv, x86::mem(0x86B3C8, 4), x86::reg32(0x86B5B0));
	mov(mv, x86::mem(0x86B3CC, 4), x86::reg32(0x7));
	retn(mv, &ts->esp);
}

void unknown_libname_138(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x86B3D0));
	goto loc_5911C0;
...
loc_5911C4:
	test(&ts->eflags, x86::reg32(ts->edx), x86::reg32(ts->edx));
	if (!ts->eflags.zero) {
        goto loc_5911D0;
    }
...
loc_591309:
	...
	inc(&ts->edx);
	cmp(&ts->eflags, x86::reg32(ts->edx), x86::reg32(0x2));
	if (ts->eflags.sign != ts->eflags.overflow) {
        goto loc_5911C4;
    }
	retn(mv, &ts->esp);
...
void sub_77E120(x86::thread_state* ts, x86::memory_view* mv) {
	mov(mv, x86::mem(0x86B510, 4), x86::reg32(0x3E64C388));
	retn(mv, &ts->esp);
}

void sub_77E130(x86::thread_state* ts, x86::memory_view* mv) {
	mov(mv, &ts->eax, x86::mem(0x86B510, 4));
	mov(mv, x86::mem(0x7FC95C, 4), x86::reg32(ts->eax));
...
void sub_77E150(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x86B5A8));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782430));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77E170(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x86B4C0));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782420));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77E190(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x5A8BD0));
	push(mv, &ts->esp, x86::reg32(0x5B0E30));
	push(mv, &ts->esp, x86::reg32(0x34026));
	mov(&ts->ecx, x86::reg32(0x86B580));
	game::sub_43C0B0(ts, mv);
	retn(mv, &ts->esp);
}
...
void sub_77E1B0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x5A8BD0));
	push(mv, &ts->esp, x86::reg32(0x5B0E30));
	push(mv, &ts->esp, x86::reg32(0x34027));
	mov(&ts->ecx, x86::reg32(0x86B4AC));
	game::sub_43C0B0(ts, mv);
	retn(mv, &ts->esp);
}
...
void sub_77E1F0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x5B8000));
	push(mv, &ts->esp, x86::reg32(0x5C1020));
	push(mv, &ts->esp, x86::reg32(0x6));
	push(mv, &ts->esp, x86::reg32(0x370));
	push(mv, &ts->esp, x86::reg32(0x874C40));
	game::sub_75C461(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782470));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77E220(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x872B4C));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7824A0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77E240(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x8763B0));
	game::sub_57BCD0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7824B0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77E2B0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(ts->esi));
	push(mv, &ts->esp, x86::reg32(ts->edi));
	mov(&ts->esi, x86::reg32(0x871BE0));
	mov(&ts->edi, x86::reg32(0x6));
	lea(mv, &ts->esp, x86::mem(ts->esp, 4));

loc_77E2C0:
	mov(&ts->ecx, x86::reg32(ts->esi));
	game::sub_44F5A0(ts, mv);
	add(&ts->esi, x86::reg32(0x290));
	dec(&ts->edi);
	if (!ts->eflags.zero) {
        goto loc_77E2C0;
    }
...
void sub_77E2E0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(mv, x86::mem(0x871B90, 2), x86::reg16(0x4000));
	retn(mv, &ts->esp);
}
...
void sub_77E470(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x782440));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77E480(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x872ED0));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7824C0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77E4A0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x872B44));
	game::sub_57BCD0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7824D0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77E4C0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x870D28));
	game::sub_57BCD0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7824E0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77E4E0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7A45F4));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x4));
	mov(mv, x86::mem(0x870A18, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77E500(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7A4604));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x4));
	mov(mv, x86::mem(0x8764C0, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77E520(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x5CF410));
	push(mv, &ts->esp, x86::reg32(0x5CF3F0));
	push(mv, &ts->esp, x86::reg32(0x10));
	push(mv, &ts->esp, x86::reg32(0xB8));
	push(mv, &ts->esp, x86::reg32(0x870D30));
	game::sub_75C461(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7824F0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void unknown_libname_144(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x870CB0));
	goto loc_5B7600;

loc_5B7600:
	mov(&ts->eax, x86::reg32(ts->ecx));
	xor_(&ts->ecx, x86::reg32(ts->ecx));
	mov(&ts->edx, x86::reg32(0x1));
	mov(mv, x86::mem(ts->eax + 0x6C, 4), x86::reg32(ts->ecx));
	mov(mv, x86::mem(ts->eax + 0x8, 4), x86::reg32(ts->ecx));
	mov(mv, x86::mem(ts->eax + 0xC, 4), x86::reg32(ts->ecx));
	mov(mv, x86::mem(ts->eax + 0x10, 4), x86::reg32(ts->ecx));
	mov(mv, x86::mem(ts->eax + 0x14, 4), x86::reg32(ts->ecx));
	mov(mv, x86::mem(ts->eax + 0x20, 4), x86::reg32(ts->ecx));
	mov(mv, x86::mem(ts->eax + 0x24, 4), x86::reg32(ts->ecx));
	mov(mv, x86::mem(ts->eax + 0x3C, 4), x86::reg32(ts->ecx));
	mov(mv, x86::mem(ts->eax + 0x44, 4), x86::reg32(ts->ecx));
	mov(mv, x86::mem(ts->eax + 0x48, 4), x86::reg32(ts->ecx));
	mov(mv, x86::mem(ts->eax + 0x60, 4), x86::reg32(ts->ecx));
	mov(mv, x86::mem(ts->eax + 0x2C, 4), x86::reg32(ts->ecx));
	mov(mv, x86::mem(ts->eax + 0x30, 4), x86::reg32(ts->ecx));
	mov(mv, x86::mem(ts->eax + 0x34, 4), x86::reg32(ts->ecx));
	mov(mv, x86::mem(ts->eax + 0x40, 4), x86::reg32(ts->ecx));
	mov(mv, x86::mem(ts->eax + 0x4C, 4), x86::reg32(ts->ecx));
	mov(mv, x86::mem(ts->eax + 0x50, 4), x86::reg32(ts->ecx));
	mov(mv, x86::mem(ts->eax + 0x54, 4), x86::reg32(ts->ecx));
	mov(mv, x86::mem(ts->eax + 0x5C, 4), x86::reg32(ts->ecx));
	mov(mv, x86::mem(ts->eax + 0x58, 4), x86::reg32(ts->ecx));
	mov(mv, x86::mem(ts->eax + 0x68, 4), x86::reg32(ts->edx));
	mov(mv, x86::mem(ts->eax + 0x28, 4), x86::reg32(ts->ecx));
	mov(mv, x86::mem(ts->eax + 0x74, 4), x86::reg32(ts->ecx));
	mov(mv, x86::mem(ts->eax, 4), x86::reg32(ts->edx));
	mov(mv, x86::mem(ts->eax + 0x4, 4), x86::reg32(0x78));
	mov(mv, x86::mem(ts->eax + 0x70, 4), x86::reg32(ts->ecx));
	mov(mv, x86::mem(ts->eax + 0x38, 4), x86::reg32(ts->edx));
	mov(mv, x86::mem(ts->eax + 0x64, 4), x86::reg32(ts->edx));
	retn(mv, &ts->esp);
}

void unknown_libname_145(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x8764C8));
	goto loc_5B7600;
...
void sub_77E570(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x782450));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77E580(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x8763D0));
	game::sub_5C8600(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782460));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77E5A0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x871B94));
	game::sub_48B790(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782490));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77E5E0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x88EA68));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782580));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77E600(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x88FF98));
	game::sub_57BCD0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782600));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77E620(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x88F270));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782610));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77E640(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x88F1BC));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782690));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77E660(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x88F748));
	game::sub_57BCD0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782510));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77E680(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x88EA8C));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782590));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77E6A0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x88F768));
	game::sub_5E81D0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7826C0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77E6C0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x5E8660));
	push(mv, &ts->esp, x86::reg32(0x5E81C0));
	push(mv, &ts->esp, x86::reg32(0x80034130));
	mov(&ts->ecx, x86::reg32(0x88A2AC));
	game::sub_43C0B0(ts, mv);
	retn(mv, &ts->esp);
}
...
void sub_77E6E0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x5E8660));
	push(mv, &ts->esp, x86::reg32(0x5E81C0));
	push(mv, &ts->esp, x86::reg32(0x3412F));
	mov(&ts->ecx, x86::reg32(0x88E9EC));
	game::sub_43C0B0(ts, mv);
	retn(mv, &ts->esp);
}

void sub_77E700(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x88F740));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782620));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77E720(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x5D84D0));
	push(mv, &ts->esp, x86::reg32(0x5D8470));
	push(mv, &ts->esp, x86::reg32(0x34146));
	mov(&ts->ecx, x86::reg32(0x88EAC4));
	game::sub_43C0B0(ts, mv);
	retn(mv, &ts->esp);
}

void sub_77E740(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x5D3EF0));
	push(mv, &ts->esp, x86::reg32(0x5D3EB0));
	push(mv, &ts->esp, x86::reg32(0x34201));
	mov(&ts->ecx, x86::reg32(0x88F750));
	game::sub_43C0B0(ts, mv);
	retn(mv, &ts->esp);
}

void sub_77E760(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x88A320));
	game::sub_5E3F90(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7826A0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77E780(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x88F298));
	game::sub_5E08B0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782630));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77E7A0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x5DEE00));
	push(mv, &ts->esp, x86::reg32(0x5DA490));
	push(mv, &ts->esp, x86::reg32(0x80034147));
	mov(&ts->ecx, x86::reg32(0x88E9CC));
	game::sub_43C0B0(ts, mv);
	retn(mv, &ts->esp);
}

void unknown_libname_146(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x88EB00));
	goto loc_5DEF40;

loc_5DEF40:
	push(mv, &ts->esp, x86::reg32(ts->ebx));
	xor_(&ts->ebx, x86::reg32(ts->ebx));
	push(mv, &ts->esp, x86::reg32(ts->esi));
	mov(&ts->esi, x86::reg32(ts->ecx));
	mov(mv, x86::mem(ts->esi, 4), x86::reg32(ts->ebx));
	mov(mv, x86::mem(ts->esi + 0x4, 4), x86::reg32(ts->ebx));
	mov(mv, x86::mem(ts->esi + 0x8, 4), x86::reg32(ts->ebx));
	mov(mv, x86::mem(ts->esi + 0xC, 4), x86::reg32(ts->ebx));
	mov(mv, x86::mem(ts->esi + 0x1C, 4), x86::reg32(ts->ebx));
	mov(mv, x86::mem(ts->esi + 0x20, 4), x86::reg32(ts->ebx));
	mov(mv, x86::mem(ts->esi + 0x24, 4), x86::reg32(ts->ebx));
	mov(mv, x86::mem(ts->esi + 0x28, 4), x86::reg32(ts->ebx));
	mov(mv, x86::mem(ts->esi + 0x2C, 4), x86::reg32(ts->ebx));
	mov(mv, x86::mem(ts->esi + 0x14, 4), x86::reg32(ts->ebx));
	mov(mv, x86::mem(ts->esi + 0x18, 4), x86::reg32(ts->ebx));
	mov(mv, x86::mem(ts->esi + 0x298, 4), x86::reg32(ts->ebx));
	mov(mv, x86::mem(ts->esi + 0x288, 1), x86::reg8(ts->bl));
	mov(mv, x86::mem(ts->esi + 0x289, 1), x86::reg8(ts->bl));
	mov(mv, x86::mem(ts->esi + 0x28C, 4), x86::reg32(ts->ebx));
	mov(mv, x86::mem(ts->esi + 0x290, 4), x86::reg32(ts->ebx));
	mov(mv, x86::mem(ts->esi + 0x294, 1), x86::reg8(ts->bl));
	game::sub_5DA890(ts, mv);
	mov(mv, x86::mem(ts->esi + 0xC4, 1), x86::reg8(ts->bl));
	mov(mv, x86::mem(ts->esi + 0x120, 1), x86::reg8(ts->bl));
	or_(&ts->eax, x86::reg32(0xFFFFFFFF));
	mov(mv, x86::mem(ts->esi + 0xB0, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(ts->esi + 0x10C, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(ts->esi + 0x69C, 4), x86::reg32(ts->ebx));
	mov(mv, x86::mem(ts->esi + 0x6A0, 4), x86::reg32(ts->ebx));
	mov(mv, x86::mem(ts->esi + 0x6A4, 4), x86::reg32(ts->ebx));
	mov(mv, x86::mem(ts->esi + 0x6A8, 4), x86::reg32(ts->ebx));
	lea(mv, &ts->ecx, x86::mem(ts->esi + 0x6AC, 4));
	xor_(&ts->eax, x86::reg32(ts->eax));
	mov(mv, x86::mem(ts->ecx, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(ts->ecx + 0x4, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(ts->esi + 0x6B4, 4), x86::reg32(ts->ebx));
	mov(mv, x86::mem(ts->esi + 0x6B8, 4), x86::reg32(ts->ebx));
	mov(&ts->eax, x86::reg32(ts->esi));
	pop(mv, &ts->esp, x86::reg32(ts->esi));
	pop(mv, &ts->esp, x86::reg32(ts->ebx));
	retn(mv, &ts->esp);
}
...
void sub_77E7D0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x5E4E60));
	push(mv, &ts->esp, x86::reg32(0x5DEF30));
	push(mv, &ts->esp, x86::reg32(0x34110));
	mov(&ts->ecx, x86::reg32(0x88EAB4));
	game::sub_43C0B0(ts, mv);
	retn(mv, &ts->esp);
}
...
void sub_77E7F0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x5E4E60));
	push(mv, &ts->esp, x86::reg32(0x5DEF30));
	push(mv, &ts->esp, x86::reg32(0x34113));
	mov(&ts->ecx, x86::reg32(0x88E9DC));
	game::sub_43C0B0(ts, mv);
	retn(mv, &ts->esp);
}
...
void sub_77E810(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x5E4E60));
	push(mv, &ts->esp, x86::reg32(0x5DEF30));
	push(mv, &ts->esp, x86::reg32(0x34111));
	mov(&ts->ecx, x86::reg32(0x88F27C));
	game::sub_43C0B0(ts, mv);
	retn(mv, &ts->esp);
}
...
void sub_77E830(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x5E4E60));
	push(mv, &ts->esp, x86::reg32(0x5DEF30));
	push(mv, &ts->esp, x86::reg32(0x34112));
	mov(&ts->ecx, x86::reg32(0x88EA74));
	game::sub_43C0B0(ts, mv);
	retn(mv, &ts->esp);
}

void sub_77E850(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x88EAD4));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782640));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77E870(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x88F760));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7825D0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77E890(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x5D6440));
	push(mv, &ts->esp, x86::reg32(0x5DB2E0));
	push(mv, &ts->esp, x86::reg32(0x34108));
	mov(&ts->ecx, x86::reg32(0x88EAA4));
	game::sub_43C0B0(ts, mv);
	retn(mv, &ts->esp);
}

void sub_77E8B0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x5DFBA0));
	push(mv, &ts->esp, x86::reg32(0x5DF8A0));
	push(mv, &ts->esp, x86::reg32(0x80034100));
	mov(&ts->ecx, x86::reg32(0x88E9B4));
	game::sub_43C0B0(ts, mv);
	retn(mv, &ts->esp);
}
...
void sub_77E8D0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x5DFBA0));
	push(mv, &ts->esp, x86::reg32(0x5DF8A0));
	push(mv, &ts->esp, x86::reg32(0x34107));
	mov(&ts->ecx, x86::reg32(0x88EA94));
	game::sub_43C0B0(ts, mv);
	retn(mv, &ts->esp);
}

void sub_77E8F0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x883E70));
	game::sub_5E6360(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7826B0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77E910(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x4DEF30));
	push(mv, &ts->esp, x86::reg32(0x598750));
	push(mv, &ts->esp, x86::reg32(0x8));
	push(mv, &ts->esp, x86::reg32(0x8));
	push(mv, &ts->esp, x86::reg32(0x88F1C8));
	game::sub_75C461(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782650));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77E940(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7A534C));
	mov(&ts->ecx, x86::reg32(0x88A2C0));
	game::sub_60B7E0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A534C));
	mov(&ts->ecx, x86::reg32(0x88A2F0));
	game::sub_60B7E0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782520));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77E970(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7A5364));
	mov(&ts->ecx, x86::reg32(0x88EA08));
	game::sub_60B7E0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A5364));
	mov(&ts->ecx, x86::reg32(0x88EA38));
	game::sub_60B7E0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782540));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77E9A0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7A5378));
	mov(&ts->ecx, x86::reg32(0x88F210));
	game::sub_60B7E0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A5378));
	mov(&ts->ecx, x86::reg32(0x88F240));
	game::sub_60B7E0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782560));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77E9D0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x88F28C));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782670));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77E9F0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x88FFA0));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782680));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77EA10(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x88E9C4));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7825E0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77EA30(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x88F208));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7825F0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void unknown_libname_147(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x88F278));
	goto loc_5D7B80;

loc_5D7B80:
	push(mv, &ts->esp, x86::reg32(ts->esi));
	push(mv, &ts->esp, x86::reg32(ts->edi));
	mov(&ts->edi, x86::reg32(ts->ecx));
	mov(&ts->esi, x86::reg32(0x800EE4));
	lea(mv, &ts->esp, x86::mem(ts->esp, 4));
...
loc_5D7B90:
	...
	push(mv, &ts->esp, x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	mov(mv, x86::mem(ts->esi, 4), x86::reg32(ts->eax));
	add(&ts->esi, x86::reg32(0x98));
	add(&ts->esp, x86::reg32(0x4));
	cmp(&ts->eflags, x86::reg32(ts->esi), x86::reg32(0x80201C));
	if (ts->eflags.sign != ts->eflags.overflow) {
        goto loc_5D7B90;
    }
	mov(&ts->eax, x86::reg32(ts->edi));
	pop(mv, &ts->esp, x86::reg32(ts->edi));
	pop(mv, &ts->esp, x86::reg32(ts->esi));
	retn(mv, &ts->esp);
}
...
void sub_77EA60(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x88E9FC));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7825A0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77EA80(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x88EA84));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7825B0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77EAA0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x88EADC));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7825C0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77EAC0(x86::thread_state* ts, x86::memory_view* mv) {
	...
	mov(&ts->ecx, x86::reg32(ts->eax));
	mov(&ts->edx, x86::reg32(ts->eax));
	fst(mv, &ts->fp, x86::fp_index(0), x86::mem(0x88FFB8, 4));
	fst(mv, &ts->fp, x86::fp_index(0), x86::mem(0x88FFC0, 4));
	mov(mv, x86::mem(0x88FFB0, 4), x86::reg32(ts->eax));
	fst(mv, &ts->fp, x86::fp_index(0), x86::mem(0x88FFC4, 4));
	mov(mv, x86::mem(0x88FFB4, 4), x86::reg32(ts->ecx));
	fstp(mv, &ts->fp, x86::fp_index(0), x86::mem(0x88FFCC, 4));
	mov(mv, x86::mem(0x88FFBC, 4), x86::reg32(ts->edx));
	mov(mv, x86::mem(0x88FFC8, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}
...
void sub_77EB20(x86::thread_state* ts, x86::memory_view* mv) {
	...
	mov(&ts->ecx, x86::reg32(ts->eax));
	mov(mv, x86::mem(0x8025E4, 4), x86::reg32(ts->ecx));
	mov(mv, &ts->ecx, x86::mem(0x7A5484, 4));
	mov(mv, x86::mem(0x8025E0, 4), x86::reg32(ts->eax));
	mov(&ts->eax, x86::reg32(ts->edx));
	mov(mv, x86::mem(0x802618, 4), x86::reg32(ts->edx));
	mov(&ts->edx, x86::reg32(ts->ecx));
	mov(mv, x86::mem(0x80261C, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x802620, 4), x86::reg32(ts->ecx));
	mov(mv, x86::mem(0x802624, 4), x86::reg32(ts->edx));
	retn(mv, &ts->esp);
}
...
void sub_77EB60(x86::thread_state* ts, x86::memory_view* mv) {
	...
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x4));
	mov(mv, x86::mem(0x89CF2C, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}
...
void sub_77EB80(x86::thread_state* ts, x86::memory_view* mv) {
	...
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x4));
	mov(mv, x86::mem(0x89CCEC, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}
...
void sub_77EBA0(x86::thread_state* ts, x86::memory_view* mv) {
	...
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x4));
	mov(mv, x86::mem(0x89CCF0, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}
...
void sub_77EBC0(x86::thread_state* ts, x86::memory_view* mv) {
	...
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x4));
	mov(mv, x86::mem(0x89CCE0, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}
...
void sub_77EBE0(x86::thread_state* ts, x86::memory_view* mv) {
	...
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x4));
	mov(mv, x86::mem(0x89E78C, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}
...
void sub_77EC00(x86::thread_state* ts, x86::memory_view* mv) {
	...
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x4));
	mov(mv, x86::mem(0x89CF20, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}
...
void sub_77EC20(x86::thread_state* ts, x86::memory_view* mv) {
	...
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x4));
	mov(mv, x86::mem(0x890158, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}
...
void sub_77EC40(x86::thread_state* ts, x86::memory_view* mv) {
	...
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x4));
	mov(mv, x86::mem(0x89E820, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}
...
void sub_77EC60(x86::thread_state* ts, x86::memory_view* mv) {
	...
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x4));
	mov(mv, x86::mem(0x89CF14, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77EC80(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x4));
	push(mv, &ts->esp, x86::reg32(0x8023A0));
	mov(&ts->ecx, x86::reg32(0x89CF24));
	game::sub_576770(ts, mv);
	retn(mv, &ts->esp);
}
...
void sub_77ECA0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x4));
	push(mv, &ts->esp, x86::reg32(0x8023D0));
	mov(&ts->ecx, x86::reg32(0x89CF30));
	game::sub_576770(ts, mv);
	retn(mv, &ts->esp);
}
...
void sub_77ECC0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x2));
	push(mv, &ts->esp, x86::reg32(0x802404));
	mov(&ts->ecx, x86::reg32(0x89E790));
	game::sub_576770(ts, mv);
	retn(mv, &ts->esp);
}
...
void sub_77ECE0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x2));
	push(mv, &ts->esp, x86::reg32(0x802414));
	mov(&ts->ecx, x86::reg32(0x89E824));
	game::sub_576770(ts, mv);
	retn(mv, &ts->esp);
}
...
void sub_77ED00(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x2));
	push(mv, &ts->esp, x86::reg32(0x802424));
	mov(&ts->ecx, x86::reg32(0x89CF18));
	game::sub_576770(ts, mv);
	retn(mv, &ts->esp);
}
...
void sub_77ED20(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x2));
	push(mv, &ts->esp, x86::reg32(0x802434));
	mov(&ts->ecx, x86::reg32(0x890150));
	game::sub_576770(ts, mv);
	retn(mv, &ts->esp);
}
...
void sub_77ED40(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x2));
	push(mv, &ts->esp, x86::reg32(0x802444));
	mov(&ts->ecx, x86::reg32(0x89E798));
	game::sub_576770(ts, mv);
	retn(mv, &ts->esp);
}
...
void sub_77ED60(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x4));
	push(mv, &ts->esp, x86::reg32(0x802570));
	mov(&ts->ecx, x86::reg32(0x89CCE4));
	game::sub_576770(ts, mv);
	retn(mv, &ts->esp);
}
...
void sub_77ED80(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x3));
	push(mv, &ts->esp, x86::reg32(0x802590));
	mov(&ts->ecx, x86::reg32(0x89CF0C));
	game::sub_576770(ts, mv);
	retn(mv, &ts->esp);
}

void unknown_libname_148(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x89E7A0));
	goto sub_5ED5F0;
}

void sub_77EDB0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x50F7D0));
	push(mv, &ts->esp, x86::reg32(0x5F0D00));
	push(mv, &ts->esp, x86::reg32(0x16));
	push(mv, &ts->esp, x86::reg32(0x940));
	push(mv, &ts->esp, x86::reg32(0x890160));
	game::sub_75C461(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7826D0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77EDE0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x89CF48));
	game::sub_5F9050(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7826F0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77EE00(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x8A2B50));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782840));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77EEA0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7A8DA8));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x4));
	mov(mv, x86::mem(0x8A31E0, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77EEC0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7A8DB8));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x4));
	mov(mv, x86::mem(0x8A3B00, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77EEE0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7A8DC8));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x4));
	mov(mv, x86::mem(0x8A1D90, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77EF00(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x8A2CA4));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7828A0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77EF20(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7A9114));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A9100));
	mov(mv, x86::mem(0x8A4358, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A90EC));
	mov(mv, x86::mem(0x8A435C, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A90E0));
	mov(mv, x86::mem(0x8A4360, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A90D0));
	mov(mv, x86::mem(0x8A4364, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A90C4));
	mov(mv, x86::mem(0x8A4368, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A90AC));
	mov(mv, x86::mem(0x8A436C, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A909C));
	mov(mv, x86::mem(0x8A4370, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A9088));
	mov(mv, x86::mem(0x8A4374, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A9074));
	mov(mv, x86::mem(0x8A4378, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A905C));
	mov(mv, x86::mem(0x8A437C, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A9048));
	mov(mv, x86::mem(0x8A4380, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A9034));
	mov(mv, x86::mem(0x8A4384, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A9028));
	mov(mv, x86::mem(0x8A4388, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A9010));
	mov(mv, x86::mem(0x8A438C, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A8FFC));
	mov(mv, x86::mem(0x8A4390, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x40));
	push(mv, &ts->esp, x86::reg32(0x7A8FE8));
	mov(mv, x86::mem(0x8A4394, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A8FD4));
	mov(mv, x86::mem(0x8A4398, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A8FBC));
	mov(mv, x86::mem(0x8A439C, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A8FA8));
	mov(mv, x86::mem(0x8A43A0, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A8F9C));
	mov(mv, x86::mem(0x8A43A4, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A8F88));
	mov(mv, x86::mem(0x8A43A8, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A8F74));
	mov(mv, x86::mem(0x8A43AC, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A8F5C));
	mov(mv, x86::mem(0x8A43B0, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A8F44));
	mov(mv, x86::mem(0x8A43B4, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A8F28));
	mov(mv, x86::mem(0x8A43B8, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A8F10));
	mov(mv, x86::mem(0x8A43BC, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x2C));
	mov(mv, x86::mem(0x8A43C0, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77F0C0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7A9208));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A91F4));
	mov(mv, x86::mem(0x8A4324, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A91E0));
	mov(mv, x86::mem(0x8A4328, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A91CC));
	mov(mv, x86::mem(0x8A432C, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A91B8));
	mov(mv, x86::mem(0x8A4330, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A91A4));
	mov(mv, x86::mem(0x8A4334, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A9190));
	mov(mv, x86::mem(0x8A4338, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A917C));
	mov(mv, x86::mem(0x8A433C, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A9168));
	mov(mv, x86::mem(0x8A4340, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A9154));
	mov(mv, x86::mem(0x8A4344, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A913C));
	mov(mv, x86::mem(0x8A4348, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A9124));
	mov(mv, x86::mem(0x8A434C, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x30));
	mov(mv, x86::mem(0x8A4350, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77F180(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x782720));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77F190(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x8A1DE4));
	game::sub_4AFAF0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7827E0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77F1B0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x8A3168));
	game::sub_4AFAF0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7827F0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77F1D0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x8A30F0));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7828B0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77F1F0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x8A1DFC));
	game::sub_4AFAF0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782800));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77F210(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x8A1F10));
	game::sub_4AFAF0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782810));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77F230(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->eax, x86::reg32(0x8A2CB4));
	mov(&ts->edx, x86::reg32(0x2));
	xor_(&ts->ecx, x86::reg32(ts->ecx));
	lea(mv, &ts->esp, x86::mem(ts->esp, 4));
...
void sub_77F290(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x8A2B68));
	game::sub_636AC0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782850));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77F2B0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x8A31E4));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782860));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77F2D0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(ts->esi));
	push(mv, &ts->esp, x86::reg32(ts->edi));
	push(mv, &ts->esp, x86::reg32(0x7A9340));
	game::sub_43DB50(ts, mv);
	mov(&ts->edi, x86::reg32(0x5));
	push(mv, &ts->esp, x86::reg32(0x7A9340));
	mov(mv, x86::mem(0x8A4418, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x8A441C, 4), x86::reg32(ts->edi));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A932C));
	mov(mv, x86::mem(0x8A4420, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A9318));
	mov(mv, x86::mem(0x8A4424, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A9304));
	mov(mv, x86::mem(0x8A4428, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A92F0));
	mov(mv, x86::mem(0x8A442C, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	xor_(&ts->esi, x86::reg32(ts->esi));
	push(mv, &ts->esp, x86::reg32(0x7A92DC));
	mov(mv, x86::mem(0x8A4430, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x8A4434, 4), x86::reg32(ts->esi));
	mov(mv, x86::mem(0x8A4438, 4), x86::reg32(ts->esi));
	mov(mv, x86::mem(0x8A443C, 4), x86::reg32(ts->esi));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A92DC));
	mov(mv, x86::mem(0x8A4440, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x8A4444, 4), x86::reg32(ts->edi));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A9340));
	mov(mv, x86::mem(0x8A4448, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A92C8));
	mov(mv, x86::mem(0x8A444C, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A92B4));
	mov(mv, x86::mem(0x8A4450, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A92A4));
	mov(mv, x86::mem(0x8A4454, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A92C8));
	mov(mv, x86::mem(0x8A4458, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x8A445C, 4), x86::reg32(ts->esi));
	mov(mv, x86::mem(0x8A4460, 4), x86::reg32(ts->esi));
	mov(mv, x86::mem(0x8A4464, 4), x86::reg32(ts->esi));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A92C8));
	mov(mv, x86::mem(0x8A4468, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x8A446C, 4), x86::reg32(ts->edi));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A9318));
	mov(mv, x86::mem(0x8A4470, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A9304));
	mov(mv, x86::mem(0x8A4474, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x40));
	push(mv, &ts->esp, x86::reg32(0x7A9290));
	mov(mv, x86::mem(0x8A4478, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A927C));
	mov(mv, x86::mem(0x8A447C, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A9268));
	mov(mv, x86::mem(0x8A4480, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x8A4484, 4), x86::reg32(ts->esi));
	mov(mv, x86::mem(0x8A4488, 4), x86::reg32(ts->esi));
	mov(mv, x86::mem(0x8A448C, 4), x86::reg32(ts->esi));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A9268));
	mov(mv, x86::mem(0x8A4490, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x8A4494, 4), x86::reg32(ts->edi));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A9340));
	mov(mv, x86::mem(0x8A4498, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	mov(mv, x86::mem(0x8A449C, 4), x86::reg32(ts->eax));
	push(mv, &ts->esp, x86::reg32(0x7A9254));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A92C8));
	mov(mv, x86::mem(0x8A44A0, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A9304));
	mov(mv, x86::mem(0x8A44A4, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A9240));
	mov(mv, x86::mem(0x8A44A8, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x8A44AC, 4), x86::reg32(ts->esi));
	mov(mv, x86::mem(0x8A44B0, 4), x86::reg32(ts->esi));
	mov(mv, x86::mem(0x8A44B4, 4), x86::reg32(ts->esi));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A9240));
	mov(mv, x86::mem(0x8A44B8, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x8A44BC, 4), x86::reg32(ts->edi));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A9340));
	mov(mv, x86::mem(0x8A44C0, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A932C));
	mov(mv, x86::mem(0x8A44C4, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A922C));
	mov(mv, x86::mem(0x8A44C8, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A921C));
	mov(mv, x86::mem(0x8A44CC, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x38));
	pop(mv, &ts->esp, x86::reg32(ts->edi));
	mov(mv, x86::mem(0x8A44D4, 4), x86::reg32(ts->esi));
	mov(mv, x86::mem(0x8A44D8, 4), x86::reg32(ts->esi));
	mov(mv, x86::mem(0x8A44DC, 4), x86::reg32(ts->esi));
	mov(mv, x86::mem(0x8A44D0, 4), x86::reg32(ts->eax));
	pop(mv, &ts->esp, x86::reg32(ts->esi));
	retn(mv, &ts->esp);
}

void sub_77F520(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7A8C98));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A8CC0));
	mov(mv, x86::mem(0x8A43C8, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A8CAC));
	mov(mv, x86::mem(0x8A43CC, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A8CD4));
	mov(mv, x86::mem(0x8A43D0, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A8C98));
	mov(mv, x86::mem(0x8A43D4, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A8CC0));
	mov(mv, x86::mem(0x8A43D8, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A93F4));
	mov(mv, x86::mem(0x8A43DC, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A93E0));
	mov(mv, x86::mem(0x8A43E0, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A8CC0));
	mov(mv, x86::mem(0x8A43E4, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A93F4));
	mov(mv, x86::mem(0x8A43E8, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A93E0));
	mov(mv, x86::mem(0x8A43EC, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A93CC));
	mov(mv, x86::mem(0x8A43F0, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A8CC0));
	mov(mv, x86::mem(0x8A43F4, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A93B8));
	mov(mv, x86::mem(0x8A43F8, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A93A4));
	mov(mv, x86::mem(0x8A43FC, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A9390));
	mov(mv, x86::mem(0x8A4400, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x40));
	push(mv, &ts->esp, x86::reg32(0x7A8CC0));
	mov(mv, x86::mem(0x8A4404, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A937C));
	mov(mv, x86::mem(0x8A4408, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A9368));
	mov(mv, x86::mem(0x8A440C, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A9354));
	mov(mv, x86::mem(0x8A4410, 4), x86::reg32(ts->eax));
	game::sub_43DB50(ts, mv);
	add(&ts->esp, x86::reg32(0x10));
	mov(mv, x86::mem(0x8A4414, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_77F660(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x8A3288));
	game::sub_637940(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782870));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77F680(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x8A3148));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782880));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77F6A0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x8A2C9C));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7828C0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77F6E0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x8A4260));
	game::sub_598750(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782890));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77F700(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7A9408));
	mov(&ts->ecx, x86::reg32(0x8A1F28));
	game::sub_60B780(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782730));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77F720(x86::thread_state* ts, x86::memory_view* mv) {
	...
	push(mv, &ts->esp, x86::reg32(0x502FD0));
	push(mv, &ts->esp, x86::reg32(0x1));
	push(mv, &ts->esp, x86::reg32(0x64));
	push(mv, &ts->esp, x86::reg32(0x8A42C0));
	game::sub_75C461(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782820));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77F750(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7A9410));
	mov(&ts->ecx, x86::reg32(0x8A3180));
	game::sub_60B7E0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A9410));
	mov(&ts->ecx, x86::reg32(0x8A31B0));
	game::sub_60B7E0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782740));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77F780(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7A9418));
	mov(&ts->ecx, x86::reg32(0x8A1E90));
	game::sub_60B7E0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A9418));
	mov(&ts->ecx, x86::reg32(0x8A1EC0));
	game::sub_60B7E0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782760));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77F7B0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7A9424));
	mov(&ts->ecx, x86::reg32(0x8A31F0));
	game::sub_60B7E0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A9424));
	mov(&ts->ecx, x86::reg32(0x8A3220));
	game::sub_60B7E0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782780));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77F7E0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7A9438));
	mov(&ts->ecx, x86::reg32(0x8A1E30));
	game::sub_60B7E0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A9438));
	mov(&ts->ecx, x86::reg32(0x8A1E60));
	game::sub_60B7E0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7827A0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77F810(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7A944C));
	mov(&ts->ecx, x86::reg32(0x8A3250));
	game::sub_60B780(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7A944C));
	mov(&ts->ecx, x86::reg32(0x8A326C));
	game::sub_60B780(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7827C0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77F900(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x8A7114));
	game::sub_6D8360(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7828D0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77F920(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x8A7168));
	game::sub_6D8360(ts, mv);
	mov(&ts->ecx, x86::reg32(0x8A717C));
	game::sub_6D8360(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7828E0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77F940(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x8A7140));
	game::sub_6D8360(ts, mv);
	mov(&ts->ecx, x86::reg32(0x8A7154));
	game::sub_6D8360(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7828F0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_77FC00(x86::thread_state* ts, x86::memory_view* mv) {
	...
	push(mv, &ts->esp, x86::reg32(0x0));
	call(ts, mv, x86::reg32(ts->esi));
	push(mv, &ts->esp, x86::reg32(0x7F00));
	push(mv, &ts->esp, x86::reg32(0x0));
	mov(mv, x86::mem(0x80C0CC, 4), x86::reg32(ts->eax));
	call(ts, mv, x86::reg32(ts->esi));
	push(mv, &ts->esp, x86::reg32(ts->eax));
	call(ts, mv, x86::mem(0x783338, 4));
	push(mv, &ts->esp, x86::reg32(0x7F00));
	push(mv, &ts->esp, x86::reg32(0x0));
	mov(mv, x86::mem(0x80C0D0, 4), x86::reg32(ts->eax));
	call(ts, mv, x86::mem(0x78333C, 4));
	mov(mv, x86::mem(0x80C0D4, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(0x80C0D8, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x80C0DC, 4), x86::reg32(0x0));
	mov(mv, x86::mem(0x80C0E0, 4), x86::reg32(0x7C08EC));
	mov(mv, x86::mem(0x80C0E4, 4), x86::reg32(0x0));
	pop(mv, &ts->esp, x86::reg32(ts->esi));
	retn(mv, &ts->esp);
}
...
void sub_780030(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x8A7BF8));
	game::sub_6DD240(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782900));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_780050(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x8A7E38));
	game::sub_6DD240(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782910));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_7801F0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x8A8390));
	game::sub_6DD240(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782920));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_780270(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0xFF00AAAA));
	push(mv, &ts->esp, x86::reg32(0x7C0FDC));
	mov(&ts->ecx, x86::reg32(0x8A85F0));
	game::sub_6DE3F0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782930));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_780290(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0xFFFFFF50));
	push(mv, &ts->esp, x86::reg32(0x7C0FE8));
	mov(&ts->ecx, x86::reg32(0x8A8738));
	game::sub_6DE3F0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782940));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_7802B0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x8A8718));
	mov(mv, x86::mem(0x8A8718, 4), x86::reg32(0x8A8738));
	game::sub_6DE6B0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782950));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_780330(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x8AAAD8));
	game::sub_6DB740(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782960));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_7807C0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->eax, x86::reg32(0x8AB320));
	mov(&ts->ecx, x86::reg32(0x3));
	xor_(&ts->edx, x86::reg32(ts->edx));
	lea(mv, &ts->esp, x86::mem(ts->esp, 4));

loc_7807D0:
	mov(mv, x86::mem(ts->eax - 0x8, 4), x86::reg32(ts->edx));
	mov(mv, x86::mem(ts->eax - 0x4, 4), x86::reg32(ts->edx));
	mov(mv, x86::mem(ts->eax, 4), x86::reg32(ts->edx));
	add(&ts->eax, x86::reg32(0xC));
	dec(&ts->ecx);
	if (!ts->eflags.zero) {
        goto loc_7807D0;
    }
...
void sub_7813D0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7C23B8));
	push(mv, &ts->esp, x86::reg32(0x1));
	push(mv, &ts->esp, x86::reg32(0x812504));
	push(mv, &ts->esp, x86::reg32(0x0));
	push(mv, &ts->esp, x86::reg32(0x811E38));
	push(mv, &ts->esp, x86::reg32(0x8123A0));
	mov(&ts->ecx, x86::reg32(0x8AB668));
	game::sub_6DAB80(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782970));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_781460(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7C0900));
	push(mv, &ts->esp, x86::reg32(0x1));
	push(mv, &ts->esp, x86::reg32(0x8139DC));
	push(mv, &ts->esp, x86::reg32(0x0));
	push(mv, &ts->esp, x86::reg32(0x812528));
	push(mv, &ts->esp, x86::reg32(0x813520));
	mov(&ts->ecx, x86::reg32(0x8AB6B8));
	game::sub_6DAB80(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782980));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_7814F0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x8AD4F0));
	goto sub_6F55B6;
}

void sub_7814FA(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7C2FD8));
	mov(&ts->ecx, x86::reg32(0x8AD618));
	game::sub_6F6C23(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782990));
	mov(mv, x86::mem(0x8AD618, 4), x86::reg32(0x7C2ED0));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_78153F(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7C3130));
	mov(&ts->ecx, x86::reg32(0x8AD74C));
	game::sub_6F6C23(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7829A5));
	mov(mv, x86::mem(0x8AD74C, 4), x86::reg32(0x7C30F8));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_781564(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7C3134));
	mov(&ts->ecx, x86::reg32(0x8AD7B0));
	game::sub_6F6C23(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7829B0));
	mov(mv, x86::mem(0x8AD7B0, 4), x86::reg32(0x7C30F8));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_781589(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7C3138));
	mov(&ts->ecx, x86::reg32(0x8AD7D8));
	game::sub_6F6C23(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7829BB));
	mov(mv, x86::mem(0x8AD7D8, 4), x86::reg32(0x7C30F8));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_7815AE(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7C313C));
	mov(&ts->ecx, x86::reg32(0x8AD710));
	game::sub_6F6C23(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7829C6));
	mov(mv, x86::mem(0x8AD710, 4), x86::reg32(0x7C30F8));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_7815D3(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7C3140));
	mov(&ts->ecx, x86::reg32(0x8AD800));
	game::sub_6F6C23(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7829D1));
	mov(mv, x86::mem(0x8AD800, 4), x86::reg32(0x7C30F8));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_7815F8(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7C3144));
	mov(&ts->ecx, x86::reg32(0x8AD760));
	game::sub_6F6C23(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7829DC));
	mov(mv, x86::mem(0x8AD760, 4), x86::reg32(0x7C30F8));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_78161D(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7C3148));
	mov(&ts->ecx, x86::reg32(0x8AD850));
	game::sub_6F6C23(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7829E7));
	mov(mv, x86::mem(0x8AD850, 4), x86::reg32(0x7C30F8));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_781642(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7C314C));
	mov(&ts->ecx, x86::reg32(0x8AD724));
	game::sub_6F6C23(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7829F2));
	mov(mv, x86::mem(0x8AD724, 4), x86::reg32(0x7C30F8));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_781667(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7C3150));
	mov(&ts->ecx, x86::reg32(0x8AD83C));
	game::sub_6F6C23(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x7829FD));
	mov(mv, x86::mem(0x8AD83C, 4), x86::reg32(0x7C30F8));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_78168C(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7C3154));
	mov(&ts->ecx, x86::reg32(0x8AD788));
	game::sub_6F6C23(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782A08));
	mov(mv, x86::mem(0x8AD788, 4), x86::reg32(0x7C30F8));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_7816B1(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7C3158));
	mov(&ts->ecx, x86::reg32(0x8AD814));
	game::sub_6F6C23(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782A13));
	mov(mv, x86::mem(0x8AD814, 4), x86::reg32(0x7C30F8));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_7816D6(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7C315C));
	mov(&ts->ecx, x86::reg32(0x8AD8B4));
	game::sub_6F6C23(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782A1E));
	mov(mv, x86::mem(0x8AD8B4, 4), x86::reg32(0x7C30F8));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_7816FB(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7C3160));
	mov(&ts->ecx, x86::reg32(0x8AD904));
	game::sub_6F6C23(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782A29));
	mov(mv, x86::mem(0x8AD904, 4), x86::reg32(0x7C30F8));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_781720(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7C3164));
	mov(&ts->ecx, x86::reg32(0x8AD878));
	game::sub_6F6C23(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782A34));
	mov(mv, x86::mem(0x8AD878, 4), x86::reg32(0x7C30F8));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_781745(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7C3168));
	mov(&ts->ecx, x86::reg32(0x8AD864));
	game::sub_6F6C23(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782A3F));
	mov(mv, x86::mem(0x8AD864, 4), x86::reg32(0x7C30F8));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_78176A(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7C316C));
	mov(&ts->ecx, x86::reg32(0x8AD8C8));
	game::sub_6F6C23(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782A4A));
	mov(mv, x86::mem(0x8AD8C8, 4), x86::reg32(0x7C30F8));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_78178F(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7C3170));
	mov(&ts->ecx, x86::reg32(0x8AD738));
	game::sub_6F6C23(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782A55));
	mov(mv, x86::mem(0x8AD738, 4), x86::reg32(0x7C30F8));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_7817B4(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7C3174));
	mov(&ts->ecx, x86::reg32(0x8AD828));
	game::sub_6F6C23(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782A60));
	mov(mv, x86::mem(0x8AD828, 4), x86::reg32(0x7C30F8));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_7817D9(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7C3178));
	mov(&ts->ecx, x86::reg32(0x8AD774));
	game::sub_6F6C23(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782A6B));
	mov(mv, x86::mem(0x8AD774, 4), x86::reg32(0x7C30F8));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_7817FE(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7C317C));
	mov(&ts->ecx, x86::reg32(0x8AD8A0));
	game::sub_6F6C23(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782A76));
	mov(mv, x86::mem(0x8AD8A0, 4), x86::reg32(0x7C30F8));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_781823(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7C3180));
	mov(&ts->ecx, x86::reg32(0x8AD8DC));
	game::sub_6F6C23(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782A81));
	mov(mv, x86::mem(0x8AD8DC, 4), x86::reg32(0x7C30F8));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_781848(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7C3184));
	mov(&ts->ecx, x86::reg32(0x8AD8F0));
	game::sub_6F6C23(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782A8C));
	mov(mv, x86::mem(0x8AD8F0, 4), x86::reg32(0x7C30F8));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_78186D(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7C3188));
	mov(&ts->ecx, x86::reg32(0x8AD7C4));
	game::sub_6F6C23(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782A97));
	mov(mv, x86::mem(0x8AD7C4, 4), x86::reg32(0x7C30F8));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_781892(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7C318C));
	mov(&ts->ecx, x86::reg32(0x8AD88C));
	game::sub_6F6C23(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782AA2));
	mov(mv, x86::mem(0x8AD88C, 4), x86::reg32(0x7C30F8));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_7818B7(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7C3190));
	mov(&ts->ecx, x86::reg32(0x8AD79C));
	game::sub_6F6C23(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782AAD));
	mov(mv, x86::mem(0x8AD79C, 4), x86::reg32(0x7C30F8));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_7818DC(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x7C3194));
	mov(&ts->ecx, x86::reg32(0x8AD7EC));
	game::sub_6F6C23(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x782AB8));
	mov(mv, x86::mem(0x8AD7EC, 4), x86::reg32(0x7C30F8));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_781901(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x782AC3));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_78190D(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x782ACE));
	game::_atexit(ts, mv);
	pop(mv, &ts->esp, x86::reg32(ts->ecx));
	retn(mv, &ts->esp);
}
...
void sub_781919(x86::thread_state* ts, x86::memory_view* mv) {
	...
	mov(mv, x86::mem(0x8B4A20, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}

void sub_781924(x86::thread_state* ts, x86::memory_view* mv) {
	game::sub_72D951(ts, mv);
	movzx(&ts->eax, x86::reg8(ts->al));
	mov(mv, x86::mem(0x8B4A2C, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}
...
loc_41E7C0:
	push(mv, &ts->esp, x86::reg32(0xFFFFFFFF));
	push(mv, &ts->esp, x86::reg32(0x771644));
	mov(mv, &ts->eax, x86::mem(0x0, 4));
	push(mv, &ts->esp, x86::reg32(ts->eax));
	mov(mv, x86::mem(0x0, 4), x86::reg32(ts->esp));
	push(mv, &ts->esp, x86::reg32(ts->ecx));
	push(mv, &ts->esp, x86::reg32(ts->esi));
	mov(&ts->esi, x86::reg32(ts->ecx));
	mov(mv, x86::mem(ts->esp + 0x4, 4), x86::reg32(ts->esi));
	mov(mv, x86::mem(ts->esp + 0x10, 4), x86::reg32(0x2));
	game::sub_41ABC0(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x50F7D0));
	push(mv, &ts->esp, x86::reg32(0xF));
	push(mv, &ts->esp, x86::reg32(0x920));
	lea(mv, &ts->eax, x86::mem(ts->esi + 0x910, 4));
	push(mv, &ts->esp, x86::reg32(ts->eax));
	mov(mv, x86::mem(ts->esp + 0x20, 1), x86::reg8(0x1));
	game::_eh_vector_destructor_iterator__void_P_uint_int_void__P__void_P__(ts, mv);
	lea(mv, &ts->ecx, x86::mem(ts->esi + 0x900, 4));
	mov(mv, x86::mem(ts->esp + 0x10, 1), x86::reg8(0x0));
	game::sub_413350(ts, mv);
	lea(mv, &ts->ecx, x86::mem(ts->esi + 0x394, 4));
	mov(mv, x86::mem(ts->esp + 0x10, 4), x86::reg32(0xFFFFFFFF));
	game::nullsub_1(ts, mv);
	mov(mv, &ts->ecx, x86::mem(ts->esp + 0x8, 4));
	pop(mv, &ts->esp, x86::reg32(ts->esi));
	mov(mv, x86::mem(0x0, 4), x86::reg32(ts->ecx));
	add(&ts->esp, x86::reg32(0x10));
	retn(mv, &ts->esp);

loc_771610:
	mov(mv, &ts->ecx, x86::mem(ts->ebp - 0x10, 4));
	add(&ts->ecx, x86::reg32(0x10));
	goto sub_401800;

loc_77161B:
	mov(mv, &ts->ecx, x86::mem(ts->ebp - 0x10, 4));
	add(&ts->ecx, x86::reg32(0x900));
	goto sub_413350;
...
loc_771629:
	...
	push(mv, &ts->esp, x86::reg32(0x920));
	mov(mv, &ts->eax, x86::mem(ts->ebp - 0x10, 4));
	add(&ts->eax, x86::reg32(0x910));
	push(mv, &ts->esp, x86::reg32(ts->eax));
	game::_eh_vector_destructor_iterator__void_P_uint_int_void__P__void_P__(ts, mv);
	retn(mv, &ts->esp);

loc_771644:
	mov(&ts->eax, x86::reg32(0x7DDB44));
...
void sub_781A30(x86::thread_state* ts, x86::memory_view* mv) {
	mov(mv, x86::mem(0x7EA23C, 4), x86::reg32(0x785D9C));
	retn(mv, &ts->esp);
}

void sub_781A40(x86::thread_state* ts, x86::memory_view* mv) {
	mov(mv, x86::mem(0x827E88, 4), x86::reg32(0x785DA0));
	retn(mv, &ts->esp);
}
...
void sub_781A50(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x4022C0));
	push(mv, &ts->esp, x86::reg32(0x4));
	push(mv, &ts->esp, x86::reg32(0x1C));
	push(mv, &ts->esp, x86::reg32(0x7EA240));
	game::_eh_vector_destructor_iterator__void_P_uint_int_void__P__void_P__(ts, mv);
	retn(mv, &ts->esp);
}
...
void sub_781A70(x86::thread_state* ts, x86::memory_view* mv) {
	...
	push(mv, &ts->esp, x86::reg32(0xA));
	push(mv, &ts->esp, x86::reg32(0x1C));
	push(mv, &ts->esp, x86::reg32(0x7EA2B0));
	game::_eh_vector_destructor_iterator__void_P_uint_int_void__P__void_P__(ts, mv);
	retn(mv, &ts->esp);
}
...
void sub_781A90(x86::thread_state* ts, x86::memory_view* mv) {
	...
	push(mv, &ts->esp, x86::reg32(0x6));
	push(mv, &ts->esp, x86::reg32(0x1C));
	push(mv, &ts->esp, x86::reg32(0x7EA3C8));
	game::_eh_vector_destructor_iterator__void_P_uint_int_void__P__void_P__(ts, mv);
	retn(mv, &ts->esp);
}
...
void sub_781AB0(x86::thread_state* ts, x86::memory_view* mv) {
	...
	push(mv, &ts->esp, x86::reg32(0x4));
	push(mv, &ts->esp, x86::reg32(0x1C));
	push(mv, &ts->esp, x86::reg32(0x7EA470));
	game::_eh_vector_destructor_iterator__void_P_uint_int_void__P__void_P__(ts, mv);
	retn(mv, &ts->esp);
}
...
loc_435910:
	...
	cmp(&ts->eflags, x86::reg32(ts->eax), x86::reg32(ts->esi));
	if (ts->eflags.zero) {
        goto loc_43593F;
    }
	lea(mv, &ts->esp, x86::mem(ts->esp, 4));
...
loc_435920:
	...
	mov(mv, x86::mem(ts->edx, 4), x86::reg32(ts->ecx));
	push(mv, &ts->esp, x86::reg32(ts->eax));
	mov(mv, x86::mem(ts->ecx + 0x4, 4), x86::reg32(ts->edx));
...
loc_43A110:
	push(mv, &ts->esp, x86::reg32(0xFFFFFFFF));
	push(mv, &ts->esp, x86::reg32(0x771F37));
	mov(mv, &ts->eax, x86::mem(0x0, 4));
	push(mv, &ts->esp, x86::reg32(ts->eax));
	mov(mv, x86::mem(0x0, 4), x86::reg32(ts->esp));
	push(mv, &ts->esp, x86::reg32(ts->ecx));
	...
	push(mv, &ts->esp, x86::reg32(ts->edi));
	mov(&ts->edi, x86::reg32(ts->ecx));
	mov(mv, x86::mem(ts->esp + 0x8, 4), x86::reg32(ts->edi));
	push(mv, &ts->esp, x86::reg32(0x0));
	push(mv, &ts->esp, x86::reg32(0x1));
	mov(mv, x86::mem(ts->esp + 0x1C, 4), x86::reg32(0x4));
	game::sub_438660(ts, mv);
	lea(mv, &ts->ecx, x86::mem(ts->edi + 0x48, 4));
	mov(mv, x86::mem(ts->esp + 0x14, 1), x86::reg8(0x3));
	game::sub_436800(ts, mv);
	mov(mv, &ts->eax, x86::mem(ts->edi + 0x40, 4));
	lea(mv, &ts->esi, x86::mem(ts->edi + 0x40, 4));
	cmp(&ts->eflags, x86::reg32(ts->eax), x86::reg32(ts->esi));
	mov(mv, x86::mem(ts->esp + 0x14, 1), x86::reg8(0x2));
	if (ts->eflags.zero) {
        goto loc_43A179;
    }
	goto loc_43A160;
...
loc_43A179:
	...
	cmp(&ts->eflags, x86::reg32(ts->eax), x86::reg32(ts->esi));
	mov(mv, x86::mem(ts->esp + 0x14, 1), x86::reg8(0x1));
	if (ts->eflags.zero) {
        goto loc_43A1A1;
    }
...
loc_771F00:
	mov(mv, &ts->ecx, x86::mem(ts->ebp - 0x10, 4));
	add(&ts->ecx, x86::reg32(0x28));
	goto sub_4835C0;

loc_771F0B:
	mov(mv, &ts->ecx, x86::mem(ts->ebp - 0x10, 4));
	add(&ts->ecx, x86::reg32(0x30));
	goto sub_4358E0;

loc_771F16:
	mov(mv, &ts->ecx, x86::mem(ts->ebp - 0x10, 4));
	add(&ts->ecx, x86::reg32(0x38));
	goto sub_4835C0;

loc_771F21:
	mov(mv, &ts->ecx, x86::mem(ts->ebp - 0x10, 4));
	add(&ts->ecx, x86::reg32(0x40));
	goto sub_4835C0;

loc_771F2C:
	mov(mv, &ts->ecx, x86::mem(ts->ebp - 0x10, 4));
	add(&ts->ecx, x86::reg32(0x48));
	goto sub_436800;

loc_771F37:
	mov(&ts->eax, x86::reg32(0x7DE40C));
	goto ___CxxFrameHandler;
}
...
loc_4407D0:
	...
	mov(&ts->eax, x86::reg32(ts->esi));
	cmp(&ts->eflags, x86::reg32(ts->eax), x86::reg32(ts->esi));
	mov(mv, x86::mem(ts->ecx, 4), x86::reg32(0x0));
	mov(mv, x86::mem(ts->esi, 4), x86::reg32(ts->esi));
	mov(mv, x86::mem(ts->esi + 0x4, 4), x86::reg32(ts->esi));
	if (ts->eflags.zero) {
        goto loc_4407FE;
    }
...
loc_4579A0:
	...
	push(mv, &ts->esp, x86::reg32(0x452BC0));
	push(mv, &ts->esp, x86::reg32(ts->ecx));
	push(mv, &ts->esp, x86::reg32(0x14));
	push(mv, &ts->esp, x86::reg32(ts->eax));
	game::_eh_vector_destructor_iterator__void_P_uint_int_void__P__void_P__(ts, mv);
	push(mv, &ts->esp, x86::reg32(ts->edi));
	game::j__free(ts, mv);
...
loc_4579CF:
	...
	lea(mv, &ts->edi, x86::mem(ts->eax - 0x4, 4));
	push(mv, &ts->esp, x86::reg32(0x452BC0));
	push(mv, &ts->esp, x86::reg32(ts->edx));
	push(mv, &ts->esp, x86::reg32(0x14));
	push(mv, &ts->esp, x86::reg32(ts->eax));
	game::_eh_vector_destructor_iterator__void_P_uint_int_void__P__void_P__(ts, mv);
	push(mv, &ts->esp, x86::reg32(ts->edi));
...
loc_4579F3:
	...
	test(&ts->eflags, x86::reg32(ts->esi), x86::reg32(ts->esi));
	if (ts->eflags.zero) {
        goto loc_457A17;
    }
	mov(mv, &ts->eax, x86::mem(ts->esi - 0x4, 4));
...
loc_491B50:
	mov(mv, &ts->ecx, x86::mem(ts->eax, 4));
	mov(mv, &ts->edx, x86::mem(ts->eax + 0x4, 4));
	add(&ts->eax, x86::reg32(0xFFFFFFFC));
	test(&ts->eflags, x86::reg32(ts->eax), x86::reg32(ts->eax));
	mov(mv, x86::mem(ts->edx, 4), x86::reg32(ts->ecx));
	mov(mv, x86::mem(ts->ecx + 0x4, 4), x86::reg32(ts->edx));
	if (ts->eflags.zero) {
...
loc_491B80:
	...
	cmp(&ts->eflags, x86::reg32(ts->esi), x86::reg32(ts->edi));
	if (ts->eflags.zero) {
        goto loc_491BB6;
    }
	lea(mv, &ts->ebx, x86::mem(ts->ebx, 4));
...
loc_4945C0:
	push(mv, &ts->esp, x86::reg32(0xFFFFFFFF));
	push(mv, &ts->esp, x86::reg32(0x772828));
	mov(mv, &ts->eax, x86::mem(0x0, 4));
	push(mv, &ts->esp, x86::reg32(ts->eax));
	mov(mv, x86::mem(0x0, 4), x86::reg32(ts->esp));
	push(mv, &ts->esp, x86::reg32(ts->ecx));
	...
	mov(mv, x86::mem(ts->esp + 0x10, 4), x86::reg32(0x0));
...
loc_495130:
	...
	cmp(&ts->eflags, x86::reg32(ts->eax), x86::reg32(ts->edi));
	if (ts->eflags.zero) {
        goto loc_495168;
    }
	push(mv, &ts->esp, x86::reg32(ts->esi));
...
loc_5104B0:
	mov(&ts->eax, x86::reg32(0x78F544));
	mov(mv, x86::mem(ts->ecx + 0xDC, 4), x86::reg32(0x79AA90));
	mov(mv, x86::mem(ts->ecx + 0xE4, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(ts->ecx, 4), x86::reg32(0x79AA90));
	mov(mv, x86::mem(ts->ecx + 0x8, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);
}
...
loc_512E40:
	push(mv, &ts->esp, x86::reg32(0xFFFFFFFF));
	push(mv, &ts->esp, x86::reg32(0x7775AE));
	mov(mv, &ts->eax, x86::mem(0x0, 4));
	push(mv, &ts->esp, x86::reg32(ts->eax));
	mov(mv, x86::mem(0x0, 4), x86::reg32(ts->esp));
	push(mv, &ts->esp, x86::reg32(ts->ecx));
	...
	mov(&ts->esi, x86::reg32(ts->ecx));
	mov(mv, x86::mem(ts->esp + 0x4, 4), x86::reg32(ts->esi));
	push(mv, &ts->esp, x86::reg32(0x401800));
	push(mv, &ts->esp, x86::reg32(0x3));
	push(mv, &ts->esp, x86::reg32(0x8F0));
	lea(mv, &ts->eax, x86::mem(ts->esi + 0x4240, 4));
	push(mv, &ts->esp, x86::reg32(ts->eax));
	mov(mv, x86::mem(ts->esp + 0x20, 4), x86::reg32(0x0));
	game::_eh_vector_destructor_iterator__void_P_uint_int_void__P__void_P__(ts, mv);
	push(mv, &ts->esp, x86::reg32(0x4FE270));
	push(mv, &ts->esp, x86::reg32(0x6));
	push(mv, &ts->esp, x86::reg32(0xC));
	add(&ts->esi, x86::reg32(0xD2C));
	push(mv, &ts->esp, x86::reg32(ts->esi));
	mov(mv, x86::mem(ts->esp + 0x20, 4), x86::reg32(0xFFFFFFFF));
	game::_eh_vector_destructor_iterator__void_P_uint_int_void__P__void_P__(ts, mv);
	mov(mv, &ts->ecx, x86::mem(ts->esp + 0x8, 4));
	pop(mv, &ts->esp, x86::reg32(ts->esi));
	mov(mv, x86::mem(0x0, 4), x86::reg32(ts->ecx));
...
loc_7775A0:
	mov(mv, &ts->ecx, x86::mem(ts->ebp - 0x10, 4));
	add(&ts->ecx, x86::reg32(0xD24));
	goto loc_500390;

SEH_532740:
	mov(&ts->eax, x86::reg32(0x7E251C));
	goto ___CxxFrameHandler;
...
loc_531CC0:
	push(mv, &ts->esp, x86::reg32(0xFFFFFFFF));
	push(mv, &ts->esp, x86::reg32(0x777929));
	mov(mv, &ts->eax, x86::mem(0x0, 4));
	push(mv, &ts->esp, x86::reg32(ts->eax));
	mov(mv, x86::mem(0x0, 4), x86::reg32(ts->esp));
	push(mv, &ts->esp, x86::reg32(ts->ecx));
	...
	push(mv, &ts->esp, x86::reg32(0x525CE0));
	push(mv, &ts->esp, x86::reg32(0x2));
	push(mv, &ts->esp, x86::reg32(0xAB4C));
	add(&ts->esi, x86::reg32(0x10));
	push(mv, &ts->esp, x86::reg32(ts->esi));
	mov(mv, x86::mem(ts->esp + 0x20, 4), x86::reg32(0xFFFFFFFF));
	game::_eh_vector_destructor_iterator__void_P_uint_int_void__P__void_P__(ts, mv);
	mov(mv, &ts->ecx, x86::mem(ts->esp + 0x8, 4));
...
loc_5398E0:
	push(mv, &ts->esp, x86::reg32(0xFFFFFFFF));
	push(mv, &ts->esp, x86::reg32(0x7776F6));
	mov(mv, &ts->eax, x86::mem(0x0, 4));
	push(mv, &ts->esp, x86::reg32(ts->eax));
	mov(mv, x86::mem(0x0, 4), x86::reg32(ts->esp));
	push(mv, &ts->esp, x86::reg32(ts->ecx));
...
loc_7776EB:
	mov(mv, &ts->ecx, x86::mem(ts->ebp - 0x10, 4));
	add(&ts->ecx, x86::reg32(0x50));
	goto sub_401800;

SEH_53ADF0:
	mov(&ts->eax, x86::reg32(0x7E2BAC));
	goto ___CxxFrameHandler;
}
...
void sub_7821D0(x86::thread_state* ts, x86::memory_view* mv) {
	mov(mv, x86::mem(0x865930, 4), x86::reg32(0x7A0604));
	retn(mv, &ts->esp);
}
...
void unknown_libname_225(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x86A454));
	goto sub_584730;
}

void unknown_libname_226(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x86A388));
	goto std__locale___Locimp____Locimp_void__5884E0;
}

void unknown_libname_227(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x86A490));
	goto loc_588580;

loc_588580:
	push(mv, &ts->esp, x86::reg32(0xFFFFFFFF));
	push(mv, &ts->esp, x86::reg32(0x7789B3));
	mov(mv, &ts->eax, x86::mem(0x0, 4));
	push(mv, &ts->esp, x86::reg32(ts->eax));
	mov(mv, x86::mem(0x0, 4), x86::reg32(ts->esp));
	push(mv, &ts->esp, x86::reg32(ts->ecx));
	...
	mov(&ts->esi, x86::reg32(ts->ecx));
	push(mv, &ts->esp, x86::reg32(ts->edi));
	mov(mv, x86::mem(ts->esp + 0xC, 4), x86::reg32(ts->esi));
	mov(mv, x86::mem(ts->esp + 0x18, 4), x86::reg32(0x1));
	game::sub_587790(ts, mv);
	lea(mv, &ts->edi, x86::mem(ts->esi + 0x8, 4));
	xor_(&ts->ebx, x86::reg32(ts->ebx));
	lea(mv, &ts->ecx, x86::mem(ts->edi + 0x10, 4));
	mov(mv, x86::mem(ts->edi, 1), x86::reg8(ts->bl));
	mov(mv, x86::mem(ts->edi + 0x140, 4), x86::reg32(ts->ebx));
	game::sub_583220(ts, mv);
	lea(mv, &ts->ecx, x86::mem(ts->edi + 0xA8, 4));
	game::sub_583220(ts, mv);
	mov(mv, &ts->eax, x86::mem(ts->esi + 0x150, 4));
	push(mv, &ts->esp, x86::reg32(ts->eax));
	mov(mv, x86::mem(ts->esi + 0x14C, 1), x86::reg8(ts->bl));
	game::j__free(ts, mv);
	add(&ts->esp, x86::reg32(0x4));
	mov(&ts->ecx, x86::reg32(ts->edi));
	mov(mv, x86::mem(ts->esi + 0x150, 4), x86::reg32(ts->ebx));
	mov(mv, x86::mem(ts->esp + 0x18, 1), x86::reg8(ts->bl));
	game::sub_4CBAF0(ts, mv);
	cmp(mv, &ts->eflags, x86::mem(ts->esi, 4), x86::reg32(ts->esi));
	mov(mv, x86::mem(ts->esp + 0x18, 4), x86::reg32(0xFFFFFFFF));
	if (ts->eflags.zero) {
        goto loc_58861B;
    }
	mov(&ts->edi, x86::reg32(ts->edi));
...
loc_778AE6:
	mov(&ts->eax, x86::reg32(0x7E4140));
	goto ___CxxFrameHandler;
}

void unknown_libname_232(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x86A858));
	goto loc_58F5C0;

loc_58F5C0:
	push(mv, &ts->esp, x86::reg32(0xFFFFFFFF));
	push(mv, &ts->esp, x86::reg32(0x778AF8));
	mov(mv, &ts->eax, x86::mem(0x0, 4));
	push(mv, &ts->esp, x86::reg32(ts->eax));
	mov(mv, x86::mem(0x0, 4), x86::reg32(ts->esp));
	push(mv, &ts->esp, x86::reg32(ts->ecx));
...
loc_5A8FE0:
	...
	test(&ts->eflags, x86::reg32(ts->ecx), x86::reg32(ts->ecx));
	if (ts->eflags.zero) {
        goto loc_5A8FFA;
    }
...
loc_5E0800:
	...
	cmp(&ts->eflags, x86::reg32(ts->ecx), x86::reg32(ts->esi));
	if (ts->eflags.zero) {
        goto loc_5E082E;
    }
	lea(mv, &ts->esp, x86::mem(ts->esp, 4));
...
loc_5E0810:
	...
	mov(mv, x86::mem(ts->edx, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(ts->eax + 0x4, 4), x86::reg32(ts->edx));
	game::nullsub_1(ts, mv);
	push(mv, &ts->esp, x86::reg32(ts->ecx));
	game::j__free(ts, mv);
...
void sub_782520(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x605400));
	push(mv, &ts->esp, x86::reg32(0x2));
	push(mv, &ts->esp, x86::reg32(0x30));
	push(mv, &ts->esp, x86::reg32(0x88A2C0));
	game::_eh_vector_destructor_iterator__void_P_uint_int_void__P__void_P__(ts, mv);
	retn(mv, &ts->esp);
}
...
void sub_782540(x86::thread_state* ts, x86::memory_view* mv) {
	...
	push(mv, &ts->esp, x86::reg32(0x2));
	push(mv, &ts->esp, x86::reg32(0x30));
	push(mv, &ts->esp, x86::reg32(0x88EA08));
	game::_eh_vector_destructor_iterator__void_P_uint_int_void__P__void_P__(ts, mv);
	retn(mv, &ts->esp);
}
...
void sub_782560(x86::thread_state* ts, x86::memory_view* mv) {
	...
	push(mv, &ts->esp, x86::reg32(0x2));
	push(mv, &ts->esp, x86::reg32(0x30));
	push(mv, &ts->esp, x86::reg32(0x88F210));
	game::_eh_vector_destructor_iterator__void_P_uint_int_void__P__void_P__(ts, mv);
	retn(mv, &ts->esp);
}
...
loc_5E48A0:
	add(&ts->ecx, x86::reg32(0x4A0));
	mov(mv, x86::mem(ts->ecx, 4), x86::reg32(ts->ecx));
	mov(mv, x86::mem(ts->ecx + 0x4, 4), x86::reg32(ts->ecx));
	goto loc_5E0800;
}
...
loc_5E5B10:
	push(mv, &ts->esp, x86::reg32(0xFFFFFFFF));
	push(mv, &ts->esp, x86::reg32(0x779593));
	mov(mv, &ts->eax, x86::mem(0x0, 4));
	push(mv, &ts->esp, x86::reg32(ts->eax));
	mov(mv, x86::mem(0x0, 4), x86::reg32(ts->esp));
	push(mv, &ts->esp, x86::reg32(ts->ecx));
	...
	mov(&ts->esi, x86::reg32(ts->ecx));
	push(mv, &ts->esp, x86::reg32(ts->edi));
	mov(mv, x86::mem(ts->esp + 0x8, 4), x86::reg32(ts->esi));
	push(mv, &ts->esp, x86::reg32(0x0));
	mov(mv, x86::mem(ts->esp + 0x18, 4), x86::reg32(0x1));
...
loc_5E6490:
	push(mv, &ts->esp, x86::reg32(0xFFFFFFFF));
	push(mv, &ts->esp, x86::reg32(0x779600));
	mov(mv, &ts->eax, x86::mem(0x0, 4));
	push(mv, &ts->esp, x86::reg32(ts->eax));
	mov(mv, x86::mem(0x0, 4), x86::reg32(ts->esp));
	push(mv, &ts->esp, x86::reg32(ts->ecx));
	...
	mov(&ts->eax, x86::reg32(ts->esi));
	cmp(&ts->eflags, x86::reg32(ts->eax), x86::reg32(ts->esi));
	mov(mv, x86::mem(ts->esp + 0x14, 4), x86::reg32(0x8));
	mov(mv, x86::mem(ts->esi, 4), x86::reg32(ts->esi));
	mov(mv, x86::mem(ts->esi + 0x4, 4), x86::reg32(ts->esi));
	if (ts->eflags.zero) {
        goto loc_5E64E0;
...
loc_5E64E0:
	...
	lea(mv, &ts->esi, x86::mem(ts->edi + 0x40, 4));
	cmp(&ts->eflags, x86::reg32(ts->eax), x86::reg32(ts->esi));
	mov(mv, x86::mem(ts->esp + 0x14, 1), x86::reg8(0x7));
	if (ts->eflags.zero) {
        goto loc_5E6509;
    }
	nop();
...
loc_5E6509:
	...
	lea(mv, &ts->esi, x86::mem(ts->edi + 0x38, 4));
	cmp(&ts->eflags, x86::reg32(ts->eax), x86::reg32(ts->esi));
	mov(mv, x86::mem(ts->esp + 0x14, 1), x86::reg8(0x6));
	if (ts->eflags.zero) {
        goto loc_5E6531;
    }
...
loc_5E6531:
	...
	cmp(&ts->eflags, x86::reg32(ts->eax), x86::reg32(ts->esi));
	mov(mv, x86::mem(ts->esp + 0x14, 1), x86::reg8(0x5));
	if (ts->eflags.zero) {
        goto loc_5E6559;
    }
...
loc_5E6559:
	...
	lea(mv, &ts->esi, x86::mem(ts->edi + 0x28, 4));
	cmp(&ts->eflags, x86::reg32(ts->eax), x86::reg32(ts->esi));
	mov(mv, x86::mem(ts->esp + 0x14, 1), x86::reg8(0x4));
	if (ts->eflags.zero) {
        goto loc_5E6581;
    }
...
loc_5EFCB0:
	push(mv, &ts->esp, x86::reg32(0xFFFFFFFF));
	push(mv, &ts->esp, x86::reg32(0x7798AC));
	mov(mv, &ts->eax, x86::mem(0x0, 4));
	push(mv, &ts->esp, x86::reg32(ts->eax));
	mov(mv, x86::mem(0x0, 4), x86::reg32(ts->esp));
	push(mv, &ts->esp, x86::reg32(ts->ecx));
	...
	test(&ts->eflags, x86::reg32(ts->eax), x86::reg32(ts->eax));
	mov(mv, x86::mem(ts->esp + 0x10, 4), x86::reg32(0x11));
	if (ts->eflags.zero) {
        goto loc_5EFCF6;
    }
	push(mv, &ts->esp, x86::reg32(0x3));
	...
	add(&ts->esp, x86::reg32(0x8));
	mov(mv, x86::mem(ts->esi + 0x60, 4), x86::reg32(0x0));

loc_5EFCF6:
	lea(mv, &ts->ecx, x86::mem(ts->esi + 0x1700, 4));
	mov(mv, x86::mem(ts->esp + 0x10, 1), x86::reg8(0x10));
	game::nullsub_1(ts, mv);
	lea(mv, &ts->ecx, x86::mem(ts->esi + 0x15B4, 4));
	mov(mv, x86::mem(ts->esp + 0x10, 1), x86::reg8(0xF));
	game::nullsub_1(ts, mv);
	lea(mv, &ts->ecx, x86::mem(ts->esi + 0x1468, 4));
	mov(mv, x86::mem(ts->esp + 0x10, 1), x86::reg8(0xE));
	game::nullsub_1(ts, mv);
	lea(mv, &ts->ecx, x86::mem(ts->esi + 0x131C, 4));
	mov(mv, x86::mem(ts->esp + 0x10, 1), x86::reg8(0xD));
	game::nullsub_1(ts, mv);
	lea(mv, &ts->ecx, x86::mem(ts->esi + 0x11D0, 4));
	mov(mv, x86::mem(ts->esp + 0x10, 1), x86::reg8(0xC));
	game::nullsub_1(ts, mv);
	lea(mv, &ts->ecx, x86::mem(ts->esi + 0x1084, 4));
	mov(mv, x86::mem(ts->esp + 0x10, 1), x86::reg8(0xB));
	game::nullsub_1(ts, mv);
	lea(mv, &ts->ecx, x86::mem(ts->esi + 0xF38, 4));
	mov(mv, x86::mem(ts->esp + 0x10, 1), x86::reg8(0xA));
	game::nullsub_1(ts, mv);
	lea(mv, &ts->ecx, x86::mem(ts->esi + 0xDEC, 4));
	mov(mv, x86::mem(ts->esp + 0x10, 1), x86::reg8(0x9));
	game::nullsub_1(ts, mv);
	lea(mv, &ts->ecx, x86::mem(ts->esi + 0xCA0, 4));
	mov(mv, x86::mem(ts->esp + 0x10, 1), x86::reg8(0x8));
	game::nullsub_1(ts, mv);
	lea(mv, &ts->ecx, x86::mem(ts->esi + 0xB54, 4));
	mov(mv, x86::mem(ts->esp + 0x10, 1), x86::reg8(0x7));
	game::nullsub_1(ts, mv);
	lea(mv, &ts->ecx, x86::mem(ts->esi + 0xA08, 4));
	mov(mv, x86::mem(ts->esp + 0x10, 1), x86::reg8(0x6));
	game::nullsub_1(ts, mv);
	lea(mv, &ts->ecx, x86::mem(ts->esi + 0x8BC, 4));
	mov(mv, x86::mem(ts->esp + 0x10, 1), x86::reg8(0x5));
	game::nullsub_1(ts, mv);
	lea(mv, &ts->ecx, x86::mem(ts->esi + 0x770, 4));
	mov(mv, x86::mem(ts->esp + 0x10, 1), x86::reg8(0x4));
	game::nullsub_1(ts, mv);
	lea(mv, &ts->ecx, x86::mem(ts->esi + 0x62C, 4));
	mov(mv, x86::mem(ts->esp + 0x10, 1), x86::reg8(0x3));
	game::nullsub_1(ts, mv);
	lea(mv, &ts->ecx, x86::mem(ts->esi + 0x4E8, 4));
	mov(mv, x86::mem(ts->esp + 0x10, 1), x86::reg8(0x2));
	game::nullsub_1(ts, mv);
	lea(mv, &ts->ecx, x86::mem(ts->esi + 0x3A4, 4));
	mov(mv, x86::mem(ts->esp + 0x10, 1), x86::reg8(0x1));
	game::nullsub_1(ts, mv);
...
loc_7797B0:
	mov(mv, &ts->ecx, x86::mem(ts->ebp - 0x10, 4));
	add(&ts->ecx, x86::reg32(0x11C));
	goto nullsub_1;

loc_7797BE:
	mov(mv, &ts->ecx, x86::mem(ts->ebp - 0x10, 4));
	add(&ts->ecx, x86::reg32(0x260));
	goto nullsub_1;

loc_7797CC:
	mov(mv, &ts->ecx, x86::mem(ts->ebp - 0x10, 4));
	add(&ts->ecx, x86::reg32(0x3A4));
	goto nullsub_1;

loc_7797DA:
	mov(mv, &ts->ecx, x86::mem(ts->ebp - 0x10, 4));
	add(&ts->ecx, x86::reg32(0x4E8));
	goto nullsub_1;

loc_7797E8:
	mov(mv, &ts->ecx, x86::mem(ts->ebp - 0x10, 4));
	add(&ts->ecx, x86::reg32(0x62C));
	goto nullsub_1;

loc_7797F6:
	mov(mv, &ts->ecx, x86::mem(ts->ebp - 0x10, 4));
	add(&ts->ecx, x86::reg32(0x770));
	goto nullsub_1;

loc_779804:
	mov(mv, &ts->ecx, x86::mem(ts->ebp - 0x10, 4));
	add(&ts->ecx, x86::reg32(0x8BC));
	goto nullsub_1;

loc_779812:
	mov(mv, &ts->ecx, x86::mem(ts->ebp - 0x10, 4));
	add(&ts->ecx, x86::reg32(0xA08));
	goto nullsub_1;

loc_779820:
	mov(mv, &ts->ecx, x86::mem(ts->ebp - 0x10, 4));
	add(&ts->ecx, x86::reg32(0xB54));
	goto nullsub_1;

loc_77982E:
	mov(mv, &ts->ecx, x86::mem(ts->ebp - 0x10, 4));
	add(&ts->ecx, x86::reg32(0xCA0));
	goto nullsub_1;

loc_77983C:
	mov(mv, &ts->ecx, x86::mem(ts->ebp - 0x10, 4));
	add(&ts->ecx, x86::reg32(0xDEC));
	goto nullsub_1;

loc_77984A:
	mov(mv, &ts->ecx, x86::mem(ts->ebp - 0x10, 4));
	add(&ts->ecx, x86::reg32(0xF38));
	goto nullsub_1;

loc_779858:
	mov(mv, &ts->ecx, x86::mem(ts->ebp - 0x10, 4));
	add(&ts->ecx, x86::reg32(0x1084));
	goto nullsub_1;

loc_779866:
	mov(mv, &ts->ecx, x86::mem(ts->ebp - 0x10, 4));
	add(&ts->ecx, x86::reg32(0x11D0));
	goto nullsub_1;

loc_779874:
	mov(mv, &ts->ecx, x86::mem(ts->ebp - 0x10, 4));
	add(&ts->ecx, x86::reg32(0x131C));
	goto nullsub_1;

loc_779882:
	mov(mv, &ts->ecx, x86::mem(ts->ebp - 0x10, 4));
	add(&ts->ecx, x86::reg32(0x1468));
	goto nullsub_1;

loc_779890:
	mov(mv, &ts->ecx, x86::mem(ts->ebp - 0x10, 4));
	add(&ts->ecx, x86::reg32(0x15B4));
	goto nullsub_1;

loc_77989E:
	mov(mv, &ts->ecx, x86::mem(ts->ebp - 0x10, 4));
	add(&ts->ecx, x86::reg32(0x1700));
	goto nullsub_1;

SEH_5F9050:
	mov(&ts->eax, x86::reg32(0x7E5248));
	goto ___CxxFrameHandler;
}

void unknown_libname_264(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x89E838));
	goto sub_4358E0;
}

void unknown_libname_265(x86::thread_state* ts, x86::memory_view* mv) {
	mov(&ts->ecx, x86::reg32(0x89E844));
	goto loc_60B2F0;

loc_60B2F0:
	push(mv, &ts->esp, x86::reg32(0xFFFFFFFF));
	push(mv, &ts->esp, x86::reg32(0x77A143));
	mov(mv, &ts->eax, x86::mem(0x0, 4));
	push(mv, &ts->esp, x86::reg32(ts->eax));
	mov(mv, x86::mem(0x0, 4), x86::reg32(ts->esp));
	sub(&ts->esp, x86::reg32(0x8));
	push(mv, &ts->esp, x86::reg32(ts->ebp));
	mov(&ts->ebp, x86::reg32(ts->ecx));
	push(mv, &ts->esp, x86::reg32(ts->esi));
	mov(mv, x86::mem(ts->esp + 0x8, 4), x86::reg32(ts->ebp));
	mov(mv, &ts->esi, x86::mem(ts->ebp, 4));
	cmp(&ts->eflags, x86::reg32(ts->esi), x86::reg32(ts->ebp));
	mov(mv, x86::mem(ts->esp + 0x18, 4), x86::reg32(0x0));
	if (ts->eflags.zero) {
        goto loc_60B37E;
    }
	push(mv, &ts->esp, x86::reg32(ts->edi));
...
loc_60B320:
	...
	mov(mv, x86::mem(ts->ecx, 4), x86::reg32(ts->eax));
	mov(mv, x86::mem(ts->eax + 0x4, 4), x86::reg32(ts->ecx));
	mov(mv, x86::mem(ts->esp + 0x10, 4), x86::reg32(ts->esi));
	mov(&ts->ecx, x86::reg32(ts->esi));
	mov(mv, x86::mem(ts->esp + 0x1C, 1), x86::reg8(0x1));
	game::sub_605320(ts, mv);
	mov(mv, &ts->eax, x86::mem(ts->esi + 0x20, 4));
	lea(mv, &ts->edi, x86::mem(ts->esi + 0x20, 4));
	cmp(&ts->eflags, x86::reg32(ts->eax), x86::reg32(ts->edi));
	mov(mv, x86::mem(ts->esp + 0x1C, 1), x86::reg8(0x0));
	if (ts->eflags.zero) {
        goto loc_60B36D;
    }
	lea(mv, &ts->esp, x86::mem(ts->esp, 4));
...
void sub_782740(x86::thread_state* ts, x86::memory_view* mv) {
	...
	push(mv, &ts->esp, x86::reg32(0x2));
	push(mv, &ts->esp, x86::reg32(0x30));
	push(mv, &ts->esp, x86::reg32(0x8A3180));
	game::_eh_vector_destructor_iterator__void_P_uint_int_void__P__void_P__(ts, mv);
	retn(mv, &ts->esp);
}
...
void sub_782760(x86::thread_state* ts, x86::memory_view* mv) {
	...
	push(mv, &ts->esp, x86::reg32(0x2));
	push(mv, &ts->esp, x86::reg32(0x30));
	push(mv, &ts->esp, x86::reg32(0x8A1E90));
	game::_eh_vector_destructor_iterator__void_P_uint_int_void__P__void_P__(ts, mv);
	retn(mv, &ts->esp);
}
...
void sub_782780(x86::thread_state* ts, x86::memory_view* mv) {
	...
	push(mv, &ts->esp, x86::reg32(0x2));
	push(mv, &ts->esp, x86::reg32(0x30));
	push(mv, &ts->esp, x86::reg32(0x8A31F0));
	game::_eh_vector_destructor_iterator__void_P_uint_int_void__P__void_P__(ts, mv);
	retn(mv, &ts->esp);
}
...
void sub_7827A0(x86::thread_state* ts, x86::memory_view* mv) {
	...
	push(mv, &ts->esp, x86::reg32(0x2));
	push(mv, &ts->esp, x86::reg32(0x30));
	push(mv, &ts->esp, x86::reg32(0x8A1E30));
	game::_eh_vector_destructor_iterator__void_P_uint_int_void__P__void_P__(ts, mv);
	retn(mv, &ts->esp);
}

void sub_7827C0(x86::thread_state* ts, x86::memory_view* mv) {
	push(mv, &ts->esp, x86::reg32(0x605390));
	push(mv, &ts->esp, x86::reg32(0x2));
	push(mv, &ts->esp, x86::reg32(0x1C));
	push(mv, &ts->esp, x86::reg32(0x8A3250));
	game::_eh_vector_destructor_iterator__void_P_uint_int_void__P__void_P__(ts, mv);
	retn(mv, &ts->esp);
}
...
loc_6379B0:
	push(mv, &ts->esp, x86::reg32(0xFFFFFFFF));
	push(mv, &ts->esp, x86::reg32(0x77A37D));
	mov(mv, &ts->eax, x86::mem(0x0, 4));
	push(mv, &ts->esp, x86::reg32(ts->eax));
	mov(mv, x86::mem(0x0, 4), x86::reg32(ts->esp));
	push(mv, &ts->esp, x86::reg32(ts->ecx));
	...
	test(&ts->eflags, x86::reg32(ts->eax), x86::reg32(ts->eax));
	mov(mv, x86::mem(ts->esp + 0x14, 4), x86::reg32(0x6));
	if (ts->eflags.zero) {
        goto loc_637A18;
    }
	...
	mov(mv, &ts->eax, x86::mem(ts->edi + 0x60, 4));
	mov(mv, x86::mem(ts->eax + 0x54, 4), x86::reg32(0x0));
	mov(mv, &ts->ecx, x86::mem(ts->edi + 0x60, 4));
	push(mv, &ts->esp, x86::reg32(0x0));
	mov(mv, x86::mem(ts->ecx + 0x5C, 4), x86::reg32(0x0));
...
loc_77A372:
	mov(mv, &ts->ecx, x86::mem(ts->ebp - 0x10, 4));
	add(&ts->ecx, x86::reg32(0x58));
	goto sub_6344E0;

loc_77A37D:
	mov(&ts->eax, x86::reg32(0x7E592C));
	goto ___CxxFrameHandler;
}
...
loc_6DE3A0:
	...
	cmp(&ts->eflags, x86::reg32(ts->eax), x86::reg32(ts->ecx));
	if (!ts->eflags.zero) {
        goto loc_6DE3B5;
    }
	mov(mv, &ts->eax, x86::mem(ts->ecx + 0x124, 4));
	mov(mv, x86::mem(0x8A85CC, 4), x86::reg32(ts->eax));
	retn(mv, &ts->esp);

loc_6DE3B5:
	cmp(mv, &ts->eflags, x86::mem(ts->eax + 0x124, 4), x86::reg32(ts->ecx));
	if (ts->eflags.zero) {
        goto loc_6DE3DC;
    }
...
loc_6DE3DC:
	...
	mov(mv, x86::mem(ts->eax + 0x124, 4), x86::reg32(ts->ecx));
...
loc_6DAE70:
	...
	cmp(mv, &ts->eflags, x86::mem(ts->ecx, 4), x86::reg32(0x0));
	if (ts->eflags.zero) {
        goto locret_6DAE83;
    }
	push(mv, &ts->esp, x86::reg32(ts->ecx));
